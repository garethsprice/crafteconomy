...
class Bugzilla_ListBugHistory extends Temboo_Choreography
{
     ...
     * Retrieve detailed bug history.
     *
     * @param Temboo_Session $session The session that owns this ListBugHistory choreography.
     ...
     *
     * Execution object provides access to results appropriate for this ListBugHistory choreography.
     *
     ...
     *
     * Includes setters appropriate for this ListBugHistory choreography.
     *
...
/**
 * Inputs object with appropriate setters for the ListBugHistory choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
{
   /**
     * Inputs object with appopriate setters for the ListBugHistory choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the BugID input for this ListBugHistory choreography.
     *
    ...
    /**
     * Set the value for the Password input for this ListBugHistory choreography.
     *
     * @param string $value (optional, string) Your Bugzilla password.
     * @return Bugzilla_ListBugHistory_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Server input for this ListBugHistory choreography.
     *
    ...
    /**
     * Set the value for the Username input for this ListBugHistory choreography.
     *
...
/**
 * Execution object for the ListBugHistory choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
class Bugzilla_ListBugHistory_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Bugzilla_ListBugHistory $choreo The choregraphy object for this execution.
     * @param Bugzilla_ListBugHistory_Inputs|array $inputs (optional) Inputs as Bugzilla_ListBugHistory_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ListBugHistory execution.
     *
...
/**
 * Results object with appopriate getters for the ListBugHistory choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
class Bugzilla_SearchForUsers extends Temboo_Choreography
{
     ...
     * Search for a specified Bugzilla user.
     *
     * @param Temboo_Session $session The session that owns this SearchForUsers choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this SearchForUsers choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this SearchForUsers choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the SearchForUsers choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
{
   /**
     * Inputs object with appopriate setters for the SearchForUsers choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Password input for this SearchForUsers choreography.
     *
     * @param string $value (required, string) Your Bugzilla password.
     * @return Bugzilla_SearchForUsers_Inputs For method chaining.
     */
    public function setPassword($value)
    {
    ...
    /**
     * Set the value for the SearchForUser input for this SearchForUsers choreography.
     *
    ...
    /**
     * Set the value for the Server input for this SearchForUsers choreography.
     *
     * @param string $value (optional, string) The base URL for the Bugzilla server to access. Defaults to https://api-dev.bugzilla.mozilla.org/latest. To access the test server, set to https://api-dev.bugzilla.mozilla.org/test/latest.
     * @return Bugzilla_SearchForUsers_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this SearchForUsers choreography.
     *
...
/**
 * Execution object for the SearchForUsers choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
class Bugzilla_SearchForUsers_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Bugzilla_SearchForUsers $choreo The choregraphy object for this execution.
     * @param Bugzilla_SearchForUsers_Inputs|array $inputs (optional) Inputs as Bugzilla_SearchForUsers_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this SearchForUsers execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Bugzilla_SearchForUsers_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the SearchForUsers choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
class Bugzilla_RetrieveAttachment extends Temboo_Choreography
{
     ...
     * Retrieve attachments associated with a specifig Bug ID.
     *
     * @param Temboo_Session $session The session that owns this RetrieveAttachment choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this RetrieveAttachment choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this RetrieveAttachment choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the RetrieveAttachment choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
{
   /**
     * Inputs object with appopriate setters for the RetrieveAttachment choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AttachmentID input for this RetrieveAttachment choreography.
     *
    ...
    /**
     * Set the value for the AttachmentsWithData input for this RetrieveAttachment choreography.
     *
    ...
    /**
     * Set the value for the Password input for this RetrieveAttachment choreography.
     *
     * @param string $value (optional, string) Your Bugzilla password.
     * @return Bugzilla_RetrieveAttachment_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Server input for this RetrieveAttachment choreography.
     *
     * @param string $value (optional, string) The base URL for the Bugzilla server to access. Defaults to https://api-dev.bugzilla.mozilla.org/latest. To access the test server, set to https://api-dev.bugzilla.mozilla.org/test/latest.
     * @return Bugzilla_RetrieveAttachment_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this RetrieveAttachment choreography.
     *
     * @param string $value (optional, string) Your Bugzilla username.
     * @return Bugzilla_RetrieveAttachment_Inputs For method chaining.
     */
...
/**
 * Execution object for the RetrieveAttachment choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
class Bugzilla_RetrieveAttachment_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Bugzilla_RetrieveAttachment $choreo The choregraphy object for this execution.
     * @param Bugzilla_RetrieveAttachment_Inputs|array $inputs (optional) Inputs as Bugzilla_RetrieveAttachment_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this RetrieveAttachment execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Bugzilla_RetrieveAttachment_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the RetrieveAttachment choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
class Bugzilla_ListBugComments extends Temboo_Choreography
{
     ...
     * Retrieve comments for a specifed Bug ID.
     *
     * @param Temboo_Session $session The session that owns this ListBugComments choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this ListBugComments choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ListBugComments choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the ListBugComments choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
{
   /**
     * Inputs object with appopriate setters for the ListBugComments choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the BugID input for this ListBugComments choreography.
     *
     * @param int $value (required, integer) Enter a Bug ID, for which information will be retrieved.
     * @return Bugzilla_ListBugComments_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Password input for this ListBugComments choreography.
     *
     * @param string $value (optional, string) Your Bugzilla password.
     * @return Bugzilla_ListBugComments_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Server input for this ListBugComments choreography.
     *
     * @param string $value (optional, string) The base URL for the Bugzilla server to access. Defaults to https://api-dev.bugzilla.mozilla.org/latest. To access the test server, set to https://api-dev.bugzilla.mozilla.org/test/latest.
     * @return Bugzilla_ListBugComments_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this ListBugComments choreography.
     *
     * @param string $value (optional, string) Your Bugzilla username.
     * @return Bugzilla_ListBugComments_Inputs For method chaining.
     */
...
/**
 * Execution object for the ListBugComments choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
class Bugzilla_ListBugComments_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Bugzilla_ListBugComments $choreo The choregraphy object for this execution.
     * @param Bugzilla_ListBugComments_Inputs|array $inputs (optional) Inputs as Bugzilla_ListBugComments_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ListBugComments execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Bugzilla_ListBugComments_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the ListBugComments choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
class Bugzilla_SearchForBugs extends Temboo_Choreography
{
     ...
     * Search for bugs listed by Mozilla product name.
     *
     * @param Temboo_Session $session The session that owns this SearchForBugs choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this SearchForBugs choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this SearchForBugs choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the SearchForBugs choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
{
   /**
     * Inputs object with appopriate setters for the SearchForBugs choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the BugChangeDate input for this SearchForBugs choreography.
     *
    ...
    /**
     * Set the value for the Password input for this SearchForBugs choreography.
     *
     * @param string $value (optional, string) Your Bugzilla password.
     * @return Bugzilla_SearchForBugs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Priority input for this SearchForBugs choreography.
     *
    ...
    /**
     * Set the value for the Product input for this SearchForBugs choreography.
     *
    ...
    /**
     * Set the value for the Server input for this SearchForBugs choreography.
     *
     * @param string $value (optional, string) The base URL for the Bugzilla server to access. Defaults to https://api-dev.bugzilla.mozilla.org/latest. To access the test server, set to https://api-dev.bugzilla.mozilla.org/test/latest.
     * @return Bugzilla_SearchForBugs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Severity input for this SearchForBugs choreography.
     *
    ...
    /**
     * Set the value for the Username input for this SearchForBugs choreography.
     *
     * @param string $value (required, string) Your Bugzilla username.
     * @return Bugzilla_SearchForBugs_Inputs For method chaining.
     */
...
/**
 * Execution object for the SearchForBugs choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
class Bugzilla_SearchForBugs_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Bugzilla_SearchForBugs $choreo The choregraphy object for this execution.
     * @param Bugzilla_SearchForBugs_Inputs|array $inputs (optional) Inputs as Bugzilla_SearchForBugs_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this SearchForBugs execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Bugzilla_SearchForBugs_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the SearchForBugs choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
class Bugzilla_RetrieveUser extends Temboo_Choreography
{
     ...
     * Retrieve user info.
     *
     * @param Temboo_Session $session The session that owns this RetrieveUser choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this RetrieveUser choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this RetrieveUser choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the RetrieveUser choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
{
   /**
     * Inputs object with appopriate setters for the RetrieveUser choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Password input for this RetrieveUser choreography.
     *
     * @param string $value (optional, string) Your Bugzilla password.
     * @return Bugzilla_RetrieveUser_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the QueryUserID input for this RetrieveUser choreography.
     *
    ...
    /**
     * Set the value for the Server input for this RetrieveUser choreography.
     *
     * @param string $value (optional, string) The base URL for the Bugzilla server to access. Defaults to https://api-dev.bugzilla.mozilla.org/latest. To access the test server, set to https://api-dev.bugzilla.mozilla.org/test/latest.
     * @return Bugzilla_RetrieveUser_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this RetrieveUser choreography.
     *
     * @param string $value (optional, string) Your Bugzilla username.
     * @return Bugzilla_RetrieveUser_Inputs For method chaining.
     */
...
/**
 * Execution object for the RetrieveUser choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
class Bugzilla_RetrieveUser_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Bugzilla_RetrieveUser $choreo The choregraphy object for this execution.
     * @param Bugzilla_RetrieveUser_Inputs|array $inputs (optional) Inputs as Bugzilla_RetrieveUser_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this RetrieveUser execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Bugzilla_RetrieveUser_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the RetrieveUser choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
class Bugzilla_ListAttachmentsForBug extends Temboo_Choreography
{
     ...
     * List attachments associated with a specifig Bug ID.
     *
     * @param Temboo_Session $session The session that owns this ListAttachmentsForBug choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this ListAttachmentsForBug choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ListAttachmentsForBug choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the ListAttachmentsForBug choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
{
   /**
     * Inputs object with appopriate setters for the ListAttachmentsForBug choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AttachmentsWithData input for this ListAttachmentsForBug choreography.
     *
     * @param int $value (optional, integer) Enter 1 to obtain full bug attachments data.  If null, only attachments fields will be returned with no associated data.
     * @return Bugzilla_ListAttachmentsForBug_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the BugID input for this ListAttachmentsForBug choreography.
     *
     * @param int $value (required, integer) Enter a Bug ID, for which information will be retrieved.
     * @return Bugzilla_ListAttachmentsForBug_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Password input for this ListAttachmentsForBug choreography.
     *
     * @param string $value (optional, string) Your Bugzilla password.
     * @return Bugzilla_ListAttachmentsForBug_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Server input for this ListAttachmentsForBug choreography.
     *
     * @param string $value (optional, string) The base URL for the Bugzilla server to access. Defaults to https://api-dev.bugzilla.mozilla.org/latest. To access the test server, set to https://api-dev.bugzilla.mozilla.org/test/latest.
     * @return Bugzilla_ListAttachmentsForBug_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this ListAttachmentsForBug choreography.
     *
     * @param string $value (optional, string) Your Bugzilla username.
     * @return Bugzilla_ListAttachmentsForBug_Inputs For method chaining.
     */
...
/**
 * Execution object for the ListAttachmentsForBug choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
class Bugzilla_ListAttachmentsForBug_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Bugzilla_ListAttachmentsForBug $choreo The choregraphy object for this execution.
     * @param Bugzilla_ListAttachmentsForBug_Inputs|array $inputs (optional) Inputs as Bugzilla_ListAttachmentsForBug_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ListAttachmentsForBug execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Bugzilla_ListAttachmentsForBug_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the ListAttachmentsForBug choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
class Bugzilla_RetrieveBug extends Temboo_Choreography
{
     ...
     * Retrieve detailed information for a specifed Bug ID.
     *
     * @param Temboo_Session $session The session that owns this RetrieveBug choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this RetrieveBug choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this RetrieveBug choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the RetrieveBug choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
...
{
   /**
     * Inputs object with appopriate setters for the RetrieveBug choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the BugID input for this RetrieveBug choreography.
     *
     * @param int $value (required, integer) Enter a Bug ID, for which information will be retrieved.
     * @return Bugzilla_RetrieveBug_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the IncludeFields input for this RetrieveBug choreography.
     *
    ...
    /**
     * Set the value for the Password input for this RetrieveBug choreography.
     *
     * @param string $value (optional, string) Your Bugzilla password.
     * @return Bugzilla_RetrieveBug_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Server input for this RetrieveBug choreography.
     *
     * @param string $value (optional, string) The base URL for the Bugzilla server to access. Defaults to https://api-dev.bugzilla.mozilla.org/latest. To access the test server, set to https://api-dev.bugzilla.mozilla.org/test/latest.
     * @return Bugzilla_RetrieveBug_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this RetrieveBug choreography.
     *
     * @param string $value (optional, string) Your Bugzilla username.
     * @return Bugzilla_RetrieveBug_Inputs For method chaining.
     */
...
/**
 * Execution object for the RetrieveBug choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
class Bugzilla_RetrieveBug_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Bugzilla_RetrieveBug $choreo The choregraphy object for this execution.
     * @param Bugzilla_RetrieveBug_Inputs|array $inputs (optional) Inputs as Bugzilla_RetrieveBug_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this RetrieveBug execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Bugzilla_RetrieveBug_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the RetrieveBug choreography.
 *
 * @package Temboo
 * @subpackage Bugzilla
 */
