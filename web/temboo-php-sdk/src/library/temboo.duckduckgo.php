...
class DuckDuckGo_Query_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the Format input for this Query choreography.
     *
    ...
    /**
     * Set the value for the NoHTML input for this Query choreography.
     *
    ...
    /**
     * Set the value for the NoRedirect input for this Query choreography.
     *
    ...
    /**
     * Set the value for the PrettyPrint input for this Query choreography.
     *
    ...
    /**
     * Set the value for the SkipDisambiguation input for this Query choreography.
     *
...
class DuckDuckGo_Query_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DuckDuckGo_Query $choreo The choregraphy object for this execution.
     * @param DuckDuckGo_Query_Inputs|array $inputs (optional) Inputs as DuckDuckGo_Query_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
