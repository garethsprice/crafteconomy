...
class Genability_PricingAndCalc_RunNewPriceCalculation extends Temboo_Choreography
{
     ...
     * Calculate electricity costs based on a POSTed calculation criteria. 
     *
     * @param Temboo_Session $session The session that owns this RunNewPriceCalculation choreography.
     ...
     *
     * Execution object provides access to results appropriate for this RunNewPriceCalculation choreography.
     *
     ...
     *
     * Includes setters appropriate for this RunNewPriceCalculation choreography.
     *
...
/**
 * Inputs object with appropriate setters for the RunNewPriceCalculation choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the RunNewPriceCalculation choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the POSTData input for this RunNewPriceCalculation choreography.
     *
     * @param string $value (required, json) Enter the POST payload in JSON format.
     * @return Genability_PricingAndCalc_RunNewPriceCalculation_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppID input for this RunNewPriceCalculation choreography.
     *
    ...
    /**
     * Set the value for the AppKey input for this RunNewPriceCalculation choreography.
     *
    ...
    /**
     * Set the value for the MasterTariffID input for this RunNewPriceCalculation choreography.
     *
     * @param string $value (required, string) Enter a Genability tariff ID.
     * @return Genability_PricingAndCalc_RunNewPriceCalculation_Inputs For method chaining.
     */
...
/**
 * Execution object for the RunNewPriceCalculation choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_PricingAndCalc_RunNewPriceCalculation_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_PricingAndCalc_RunNewPriceCalculation $choreo The choregraphy object for this execution.
     * @param Genability_PricingAndCalc_RunNewPriceCalculation_Inputs|array $inputs (optional) Inputs as Genability_PricingAndCalc_RunNewPriceCalculation_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this RunNewPriceCalculation execution.
     *
...
/**
 * Results object with appopriate getters for the RunNewPriceCalculation choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_PricingAndCalc_GetPrice extends Temboo_Choreography
{
     ...
     * Retrieves the consumption price of a specified Tariff over a given date range.
     *
     * @param Temboo_Session $session The session that owns this GetPrice choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetPrice choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetPrice choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetPrice choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetPrice choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AccountID input for this GetPrice choreography.
     *
     * @param string $value (optional, string) Enter a Genability ID for an account. More info on Accounts is available here: http://developer.genability.com/documentation/api-reference/account-api/account
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppID input for this GetPrice choreography.
     *
     * @param string $value (required, string) The App ID provided by Genability.
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetPrice choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ConsumptionAmount input for this GetPrice choreography.
     *
    ...
    /**
     * Set the value for the DemandAmount input for this GetPrice choreography.
     *
    ...
    /**
     * Set the value for the FromDateTime input for this GetPrice choreography.
     *
     * @param string $value (required, string) Enter the date and time of the requested start of the price query. Must be in ISO 8601 format.  Example: 2012-06-12T00:00:00.0-0700
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MasterTariffID input for this GetPrice choreography.
     *
     * @param string $value (optional, string) Enter a Genability tariff ID. Not required, if AccountID is specified.
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
    public function setMasterTariffID($value)
    {
    ...
    /**
     * Set the value for the PageCount input for this GetPrice choreography.
     *
     * @param int $value (optional, integer) Specify the number of results to be returned. Defailt is set to: 25.
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageStart input for this GetPrice choreography.
     *
     * @param int $value (optional, integer) Enter the page number to start to display results from. If unspecified, the first page of results will be returned.
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ProfileID input for this GetPrice choreography.
     *
     * @param string $value (optional, string) Enter a Genability ID of a profile. This ID can be passed instead of consumptionAmount or demandAmount.
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ProviderAccountID input for this GetPrice choreography.
     *
     * @param string $value (optional, string) Specify a unique ID for an Account. Same as AccountId, however your unique ID can be used instead of the Genability Account ID.
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the TerritoryID input for this GetPrice choreography.
     *
    ...
    /**
     * Set the value for the ToDateTime input for this GetPrice choreography.
     *
     * @param string $value (optional, string) Enter the date and time of the requested start of the price query. Must be in ISO 8601 format.  Example: 2012-06-12T00:00:00.0-0700
     * @return Genability_PricingAndCalc_GetPrice_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetPrice choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_PricingAndCalc_GetPrice_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_PricingAndCalc_GetPrice $choreo The choregraphy object for this execution.
     * @param Genability_PricingAndCalc_GetPrice_Inputs|array $inputs (optional) Inputs as Genability_PricingAndCalc_GetPrice_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetPrice execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_PricingAndCalc_GetPrice_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetPrice choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetTerritories extends Temboo_Choreography
{
     ...
     * Returns a list of Territory objects based a specified search criteria.
     *
     * @param Temboo_Session $session The session that owns this GetTerritories choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTerritories choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTerritories choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTerritories choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTerritories choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the AppKey input for this GetTerritories choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetTerritories_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ContainsItemType input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the ContainsItemValue input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the EndsWith input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the IsRegex input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the LSEID input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the MasterTariffID input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the PageCount input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the PageStart input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the PopulateItems input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the PopulateLSES input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the SearchOn input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the Search input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the SortOn input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the SortOrder input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the StartsWith input for this GetTerritories choreography.
     *
    ...
    /**
     * Set the value for the UsageTypes input for this GetTerritories choreography.
     *
...
/**
 * Execution object for the GetTerritories choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetTerritories_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetTerritories $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetTerritories_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetTerritories_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTerritories execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetTerritories_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTerritories choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetLoadServingEntity extends Temboo_Choreography
{
     ...
     * Returns a Load Serving Entity with a given ID.
     *
     * @param Temboo_Session $session The session that owns this GetLoadServingEntity choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetLoadServingEntity choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetLoadServingEntity choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetLoadServingEntity choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetLoadServingEntity choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetLoadServingEntity choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetLoadServingEntity_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetLoadServingEntity choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetLoadServingEntity_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the LSEID input for this GetLoadServingEntity choreography.
     *
...
/**
 * Execution object for the GetLoadServingEntity choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetLoadServingEntity_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetLoadServingEntity $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetLoadServingEntity_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetLoadServingEntity_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetLoadServingEntity execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetLoadServingEntity_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetLoadServingEntity choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetPropertyKeys extends Temboo_Choreography
{
     ...
     * Returns a list of Property Keys based on a specified search criteria.
     *
     * @param Temboo_Session $session The session that owns this GetPropertyKeys choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetPropertyKeys choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetPropertyKeys choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetPropertyKeys choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetPropertyKeys choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetPropertyKeys choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetPropertyKeys_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetPropertyKeys choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetPropertyKeys_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the EntityID input for this GetPropertyKeys choreography.
     *
    ...
    /**
     * Set the value for the EntityType input for this GetPropertyKeys choreography.
     *
    ...
    /**
     * Set the value for the PageCount input for this GetPropertyKeys choreography.
     *
     * @param int $value (optional, integer) The number of results to return. Defaults to 25.
     * @return Genability_TariffData_GetPropertyKeys_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageStart input for this GetPropertyKeys choreography.
     *
     * @param int $value (optional, integer) The page number to begin the result set from. Defaults to 1.
     * @return Genability_TariffData_GetPropertyKeys_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetPropertyKeys choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetPropertyKeys_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetPropertyKeys $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetPropertyKeys_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetPropertyKeys_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetPropertyKeys execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetPropertyKeys_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetPropertyKeys choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetTariffs extends Temboo_Choreography
{
     ...
     * Returns a list of Tariff objects based a specified search criteria.
     *
     * @param Temboo_Session $session The session that owns this GetTariffs choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTariffs choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTariffs choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTariffs choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTariffs choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AccountID input for this GetTariffs choreography.
     *
    ...
    /**
     * Set the value for the AppID input for this GetTariffs choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetTariffs choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the CustomerClasses input for this GetTariffs choreography.
     *
    ...
    /**
     * Set the value for the EffectiveOn input for this GetTariffs choreography.
     *
    ...
    /**
     * Set the value for the EndsWith input for this GetTariffs choreography.
     *
     * @param string $value (optional, string) When true, the search will only return results that end with the specified search string. Otherwise, any match of the search string will be returned as a result.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the FromDateTime input for this GetTariffs choreography.
     *
    ...
    /**
     * Set the value for the IsRegex input for this GetTariffs choreography.
     *
     * @param bool $value (optional, boolean) When true, the provided search string will be regarded as a regular expression and the search will return results matching the regular expression.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the LSEID input for this GetTariffs choreography.
     *
    ...
    /**
     * Set the value for the PageCount input for this GetTariffs choreography.
     *
     * @param int $value (optional, integer) The number of results to return. Defaults to 25.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageStart input for this GetTariffs choreography.
     *
     * @param int $value (optional, integer) The page number to begin the result set from. Defaults to 1.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PopulateProperties input for this GetTariffs choreography.
     *
    ...
    /**
     * Set the value for the PopulateRates input for this GetTariffs choreography.
     *
    ...
    /**
     * Set the value for the SearchOn input for this GetTariffs choreography.
     *
     * @param string $value (optional, string) Comma separated list of fields to query on. When searchOn is specified, the text provided in the search string field will be searched within these fields.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Search input for this GetTariffs choreography.
     *
     * @param string $value (optional, string) The string of text to search on. This can also be a regular expression, in which case you should set the 'isRegex' flag to true.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SortOn input for this GetTariffs choreography.
     *
     * @param string $value (optional, string) Comma separated list of fields to sort on.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SortOrder input for this GetTariffs choreography.
     *
     * @param string $value (optional, string) Comma separated list of ordering. Possible values are 'ASC' and 'DESC'. Default is 'ASC'. This list corresponds to the field list used in the SortOn input.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the StartsWith input for this GetTariffs choreography.
     *
     * @param bool $value (optional, boolean) When true, the search will only return results that begin with the specified search string. Otherwise, any match of the search string will be returned as a result.
     * @return Genability_TariffData_GetTariffs_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the TariffTypes input for this GetTariffs choreography.
     *
    ...
    /**
     * Set the value for the ToDateTime input for this GetTariffs choreography.
     *
    ...
    /**
     * Set the value for the ZipCode input for this GetTariffs choreography.
     *
...
/**
 * Execution object for the GetTariffs choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetTariffs_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetTariffs $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetTariffs_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetTariffs_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTariffs execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetTariffs_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTariffs choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetTimeOfUseGroup extends Temboo_Choreography
{
     ...
     * Returns a particular Time of Use Group with a given touGroupId and lseId.
     *
     * @param Temboo_Session $session The session that owns this GetTimeOfUseGroup choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTimeOfUseGroup choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTimeOfUseGroup choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTimeOfUseGroup choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTimeOfUseGroup choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetTimeOfUseGroup choreography.
     *
     * @param string $value (required, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetTimeOfUseGroup choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the EndsWith input for this GetTimeOfUseGroup choreography.
     *
     * @param string $value (optional, string) When true, the search will only return results that end with the specified search string. Otherwise, any match of the search string will be returned as a result.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the IsRegex input for this GetTimeOfUseGroup choreography.
     *
     * @param bool $value (optional, boolean) When true, the provided search string will be regarded as a regular expression and the search will return results matching the regular expression.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the LSEID input for this GetTimeOfUseGroup choreography.
     *
    ...
    /**
     * Set the value for the PageCount input for this GetTimeOfUseGroup choreography.
     *
     * @param int $value (optional, integer) The number of results to return. Defaults to 25.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageStart input for this GetTimeOfUseGroup choreography.
     *
     * @param int $value (optional, integer) The page number to begin the result set from. Defaults to 1.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SearchOn input for this GetTimeOfUseGroup choreography.
     *
     * @param string $value (optional, string) Comma separated list of fields to query on. When searchOn is specified, the text provided in the search string field will be searched within these fields.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Search input for this GetTimeOfUseGroup choreography.
     *
     * @param string $value (optional, string) The string of text to search on. This can also be a regular expression, in which case you should set the 'isRegex' flag to true.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SortOn input for this GetTimeOfUseGroup choreography.
     *
     * @param string $value (optional, string) Comma separated list of fields to sort on.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SortOrder input for this GetTimeOfUseGroup choreography.
     *
     * @param string $value (optional, string) Comma separated list of ordering. Possible values are 'ASC' and 'DESC'. Default is 'ASC'. This list corresponds to the field list used in the SortOn input.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the StartsWith input for this GetTimeOfUseGroup choreography.
     *
     * @param bool $value (optional, boolean) When true, the search will only return results that begin with the specified search string. Otherwise, any match of the search string will be returned as a result.
     * @return Genability_TariffData_GetTimeOfUseGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the TOUGroupID input for this GetTimeOfUseGroup choreography.
     *
...
/**
 * Execution object for the GetTimeOfUseGroup choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetTimeOfUseGroup_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetTimeOfUseGroup $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetTimeOfUseGroup_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetTimeOfUseGroup_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTimeOfUseGroup execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetTimeOfUseGroup_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTimeOfUseGroup choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_PricingAndCalc_GetTerritoryIDFromZipcode extends Temboo_Choreography
{
     ...
     * Get a territoryID, by using a consumer's zipcode, LSE ID and master tariff ID.
     *
     * @param Temboo_Session $session The session that owns this GetTerritoryIDFromZipcode choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTerritoryIDFromZipcode choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTerritoryIDFromZipcode choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTerritoryIDFromZipcode choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTerritoryIDFromZipcode choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetTerritoryIDFromZipcode choreography.
     *
     * @param string $value (required, string) The App ID provided by Genability.
     * @return Genability_PricingAndCalc_GetTerritoryIDFromZipcode_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetTerritoryIDFromZipcode choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_PricingAndCalc_GetTerritoryIDFromZipcode_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the LSEID input for this GetTerritoryIDFromZipcode choreography.
     *
     * @param string $value (required, string) Enter an LSE ID.
     * @return Genability_PricingAndCalc_GetTerritoryIDFromZipcode_Inputs For method chaining.
     */
    public function setLSEID($value)
    {
    ...
    /**
     * Set the value for the MasterTariffID input for this GetTerritoryIDFromZipcode choreography.
     *
     * @param string $value (required, string) Enter a Genability tariff ID.
     * @return Genability_PricingAndCalc_GetTerritoryIDFromZipcode_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Zipcode input for this GetTerritoryIDFromZipcode choreography.
     *
     * @param int $value (required, integer) Enter a Zipcode for which a territory ID is to be retrieved.
     * @return Genability_PricingAndCalc_GetTerritoryIDFromZipcode_Inputs For method chaining.
     */
    public function setZipcode($value)
    {
...
/**
 * Execution object for the GetTerritoryIDFromZipcode choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_PricingAndCalc_GetTerritoryIDFromZipcode_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_PricingAndCalc_GetTerritoryIDFromZipcode $choreo The choregraphy object for this execution.
     * @param Genability_PricingAndCalc_GetTerritoryIDFromZipcode_Inputs|array $inputs (optional) Inputs as Genability_PricingAndCalc_GetTerritoryIDFromZipcode_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTerritoryIDFromZipcode execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_PricingAndCalc_GetTerritoryIDFromZipcode_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTerritoryIDFromZipcode choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_PricingAndCalc_GetTariffPrice extends Temboo_Choreography
{
     ...
     * Retrieve summarized rates of a specified electricity tariff, in addition to changes in rates over a specified time span.
     *
     * @param Temboo_Session $session The session that owns this GetTariffPrice choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTariffPrice choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTariffPrice choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTariffPrice choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTariffPrice choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AccountID input for this GetTariffPrice choreography.
     *
     * @param string $value (optional, string) Enter a Genability ID for an account. This is optional if MasterTariffID is set.
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    public function setAccountID($value)
    {
    ...
    /**
     * Set the value for the AppID input for this GetTariffPrice choreography.
     *
     * @param string $value (required, string) The App ID provided by Genability.
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetTariffPrice choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ConsumptionAmount input for this GetTariffPrice choreography.
     *
     * @param float $value (optional, decimal) Specify a monthly consumption in kWh. By default the highest banded level of consumption is used.
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DemandAmount input for this GetTariffPrice choreography.
     *
     * @param float $value (optional, decimal) Specify a monthly demand in kWh. By default the highest banded level of demand is used.
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the FromDateTime input for this GetTariffPrice choreography.
     *
     * @param string $value (required, string) Enter the date and time of the requested start of the price query. Must be in ISO 8601 format.  Example: 2012-06-12T00:00:00.0-0700
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MasterTariffID input for this GetTariffPrice choreography.
     *
     * @param string $value (optional, string) Enter a Genability tariff ID. This variable is not required, if AccountID is set.
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    public function setMasterTariffID($value)
    {
    ...
    /**
     * Set the value for the PageCount input for this GetTariffPrice choreography.
     *
     * @param int $value (optional, integer) Specify the number of results to be returned. Defailt is set to: 25.
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageStart input for this GetTariffPrice choreography.
     *
     * @param int $value (optional, integer) Enter the page number to start to display results from. If unspecified, the first page of results will be returned.
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the TerritoryID input for this GetTariffPrice choreography.
     *
     * @param string $value (optional, string) Return rate changes for the specified Territory.
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ToDateTime input for this GetTariffPrice choreography.
     *
     * @param string $value (optional, string) Enter the date and time of the requested start of the price query. Must be in ISO 8601 format.  Example: 2012-06-12T00:00:00.0-0700
     * @return Genability_PricingAndCalc_GetTariffPrice_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetTariffPrice choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_PricingAndCalc_GetTariffPrice_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_PricingAndCalc_GetTariffPrice $choreo The choregraphy object for this execution.
     * @param Genability_PricingAndCalc_GetTariffPrice_Inputs|array $inputs (optional) Inputs as Genability_PricingAndCalc_GetTariffPrice_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTariffPrice execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_PricingAndCalc_GetTariffPrice_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTariffPrice choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetTariff extends Temboo_Choreography
{
     ...
     * Returns an individual Tariff object with a given id.
     *
     * @param Temboo_Session $session The session that owns this GetTariff choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTariff choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTariff choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTariff choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTariff choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetTariff choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetTariff_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetTariff choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetTariff_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MasterTariffID input for this GetTariff choreography.
     *
    ...
    /**
     * Set the value for the PopulateProperties input for this GetTariff choreography.
     *
     * @param bool $value (optional, boolean) Set to "true" to populate the properties for the returned Tariffs.
     * @return Genability_TariffData_GetTariff_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PopulateRates input for this GetTariff choreography.
     *
     * @param bool $value (optional, boolean) Set to "true" to populate the rate details for the returned Tariffs.
     * @return Genability_TariffData_GetTariff_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetTariff choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetTariff_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetTariff $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetTariff_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetTariff_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTariff execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetTariff_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTariff choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetMetricsForZipCode extends Temboo_Choreography
{
     ...
     * Returns a place object and associated facts and metrics with a given zip code.
     *
     * @param Temboo_Session $session The session that owns this GetMetricsForZipCode choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetMetricsForZipCode choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetMetricsForZipCode choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetMetricsForZipCode choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetMetricsForZipCode choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetMetricsForZipCode choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetMetricsForZipCode_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetMetricsForZipCode choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetMetricsForZipCode_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ZipCode input for this GetMetricsForZipCode choreography.
     *
...
/**
 * Execution object for the GetMetricsForZipCode choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetMetricsForZipCode_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetMetricsForZipCode $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetMetricsForZipCode_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetMetricsForZipCode_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetMetricsForZipCode execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetMetricsForZipCode_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetMetricsForZipCode choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetTerritory extends Temboo_Choreography
{
     ...
     * Returns a an individual Territory objects with a given id.
     *
     * @param Temboo_Session $session The session that owns this GetTerritory choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTerritory choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTerritory choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTerritory choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTerritory choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetTerritory choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetTerritory_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetTerritory choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetTerritory_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PopulateItems input for this GetTerritory choreography.
     *
     * @param bool $value (optional, boolean) If set to "true", returns a list of territory items for each territory in the result set.
     * @return Genability_TariffData_GetTerritory_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the TerritoryID input for this GetTerritory choreography.
     *
...
/**
 * Execution object for the GetTerritory choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetTerritory_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetTerritory $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetTerritory_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetTerritory_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTerritory execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetTerritory_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTerritory choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetTimeOfUseGroupIntervals extends Temboo_Choreography
{
     ...
     * Returns all the Intervals for a Time of Use Group within a given date range.
     *
     * @param Temboo_Session $session The session that owns this GetTimeOfUseGroupIntervals choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetTimeOfUseGroupIntervals choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetTimeOfUseGroupIntervals choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetTimeOfUseGroupIntervals choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetTimeOfUseGroupIntervals choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetTimeOfUseGroupIntervals choreography.
     *
     * @param string $value (required, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetTimeOfUseGroupIntervals_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetTimeOfUseGroupIntervals choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetTimeOfUseGroupIntervals_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the FromDateTime input for this GetTimeOfUseGroupIntervals choreography.
     *
    ...
    /**
     * Set the value for the LSEID input for this GetTimeOfUseGroupIntervals choreography.
     *
    ...
    /**
     * Set the value for the PageCount input for this GetTimeOfUseGroupIntervals choreography.
     *
     * @param int $value (optional, integer) The number of results to return. Defaults to 25.
     * @return Genability_TariffData_GetTimeOfUseGroupIntervals_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageStart input for this GetTimeOfUseGroupIntervals choreography.
     *
     * @param int $value (optional, integer) The page number to begin the result set from. Defaults to 1.
     * @return Genability_TariffData_GetTimeOfUseGroupIntervals_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the TOUGroupID input for this GetTimeOfUseGroupIntervals choreography.
     *
    ...
    /**
     * Set the value for the ToDateTime input for this GetTimeOfUseGroupIntervals choreography.
     *
...
/**
 * Execution object for the GetTimeOfUseGroupIntervals choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetTimeOfUseGroupIntervals_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetTimeOfUseGroupIntervals $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetTimeOfUseGroupIntervals_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetTimeOfUseGroupIntervals_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetTimeOfUseGroupIntervals execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetTimeOfUseGroupIntervals_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetTimeOfUseGroupIntervals choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetPropertyKey extends Temboo_Choreography
{
     ...
     * Returns an individual Property Key using a given key name.
     *
     * @param Temboo_Session $session The session that owns this GetPropertyKey choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetPropertyKey choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetPropertyKey choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetPropertyKey choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetPropertyKey choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetPropertyKey choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetPropertyKey_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetPropertyKey choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetPropertyKey_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the KeyName input for this GetPropertyKey choreography.
     *
...
/**
 * Execution object for the GetPropertyKey choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetPropertyKey_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetPropertyKey $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetPropertyKey_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetPropertyKey_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetPropertyKey execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetPropertyKey_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetPropertyKey choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetZipCodeDetails extends Temboo_Choreography
{
     ...
     * Returns the details for a given zip code.
     *
     * @param Temboo_Session $session The session that owns this GetZipCodeDetails choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetZipCodeDetails choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetZipCodeDetails choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetZipCodeDetails choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetZipCodeDetails choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetZipCodeDetails choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetZipCodeDetails_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetZipCodeDetails choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetZipCodeDetails_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageCount input for this GetZipCodeDetails choreography.
     *
     * @param int $value (optional, integer) The number of results to return. Defaults to 25.
     * @return Genability_TariffData_GetZipCodeDetails_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageStart input for this GetZipCodeDetails choreography.
     *
     * @param int $value (optional, integer) The page number to begin the result set from. Defaults to 1.
     * @return Genability_TariffData_GetZipCodeDetails_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ZipCode input for this GetZipCodeDetails choreography.
     *
...
/**
 * Execution object for the GetZipCodeDetails choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetZipCodeDetails_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetZipCodeDetails $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetZipCodeDetails_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetZipCodeDetails_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetZipCodeDetails execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetZipCodeDetails_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetZipCodeDetails choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_PricingAndCalc_CalculateTariffInputMetaData extends Temboo_Choreography
{
     ...
     * Retrieve inputs required to run a calculation for the specified tariff, within a specified period of time.
     *
     * @param Temboo_Session $session The session that owns this CalculateTariffInputMetaData choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this CalculateTariffInputMetaData choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this CalculateTariffInputMetaData choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the CalculateTariffInputMetaData choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the CalculateTariffInputMetaData choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this CalculateTariffInputMetaData choreography.
     *
     * @param string $value (required, string) The App ID provided by Genability.
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this CalculateTariffInputMetaData choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the BillingPeriod input for this CalculateTariffInputMetaData choreography.
     *
     * @param string $value (optional, string) Enter: true, or false, to specify whether results retireved should be based on a billing period, or not.  Default is set to: false.
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the CityLimits input for this CalculateTariffInputMetaData choreography.
     *
    ...
    /**
     * Set the value for the ConnectionType input for this CalculateTariffInputMetaData choreography.
     *
     * @param string $value (optional, string) Enter a connection type.  For example: Primary.
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the FromDateTime input for this CalculateTariffInputMetaData choreography.
     *
     * @param string $value (required, string) Enter the date and time of the requested start of the price query. Must be in ISO 8601 format.  Example: 2012-06-12T00:00:00.0-0700
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the GroupBy input for this CalculateTariffInputMetaData choreography.
     *
    ...
    /**
     * Set the value for the KeyName input for this CalculateTariffInputMetaData choreography.
     *
     * @param string $value (optional, string) Enter an applicability value.  If an error is returned, indicating the need for an extra applicability parameter, use this variable to set the parameter name.  For example: territoryID.
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs For method chaining.
     */
    public function setKeyName($value)
    {
    ...
    /**
     * Set the value for the KeyValue input for this CalculateTariffInputMetaData choreography.
     *
     * @param string $value (conditional, string) Enter the value for the specified KeyName variable. For example if KeyName is set to territoryID, you could provide 3385 for the KeyValue input.
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MasterTariffID input for this CalculateTariffInputMetaData choreography.
     *
     * @param string $value (required, string) Enter a Genability tariff ID.
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ToDateTime input for this CalculateTariffInputMetaData choreography.
     *
     * @param string $value (required, string) Enter the date and time of the requested start of the price query. Must be in ISO 8601 format.  Example: 2012-06-12T00:00:00.0-0700
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs For method chaining.
     */
...
/**
 * Execution object for the CalculateTariffInputMetaData choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_PricingAndCalc_CalculateTariffInputMetaData_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_PricingAndCalc_CalculateTariffInputMetaData $choreo The choregraphy object for this execution.
     * @param Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs|array $inputs (optional) Inputs as Genability_PricingAndCalc_CalculateTariffInputMetaData_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this CalculateTariffInputMetaData execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_PricingAndCalc_CalculateTariffInputMetaData_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the CalculateTariffInputMetaData choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetSeasonGroups extends Temboo_Choreography
{
     ...
     * Returns a list of Season Groups for a given Load Serving Entity.
     *
     * @param Temboo_Session $session The session that owns this GetSeasonGroups choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetSeasonGroups choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetSeasonGroups choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetSeasonGroups choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetSeasonGroups choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AppID input for this GetSeasonGroups choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetSeasonGroups choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the EndsWith input for this GetSeasonGroups choreography.
     *
     * @param string $value (optional, string) When true, the search will only return results that end with the specified search string. Otherwise, any match of the search string will be returned as a result.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the IsRegex input for this GetSeasonGroups choreography.
     *
     * @param bool $value (optional, boolean) When true, the provided search string will be regarded as a regular expression and the search will return results matching the regular expression.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the LSEID input for this GetSeasonGroups choreography.
     *
    ...
    /**
     * Set the value for the PageCount input for this GetSeasonGroups choreography.
     *
     * @param int $value (optional, integer) The number of results to return. Defaults to 25.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageStart input for this GetSeasonGroups choreography.
     *
     * @param int $value (optional, integer) The page number to begin the result set from. Defaults to 1.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SearchOn input for this GetSeasonGroups choreography.
     *
     * @param string $value (optional, string) Comma separated list of fields to query on. When searchOn is specified, the text provided in the search string field will be searched within these fields.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Search input for this GetSeasonGroups choreography.
     *
     * @param string $value (optional, string) The string of text to search on. This can also be a regular expression, in which case you should set the 'isRegex' flag to true.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SortOn input for this GetSeasonGroups choreography.
     *
     * @param string $value (optional, string) Comma separated list of fields to sort on.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SortOrder input for this GetSeasonGroups choreography.
     *
     * @param string $value (optional, string) Comma separated list of ordering. Possible values are 'ASC' and 'DESC'. Default is 'ASC'. This list corresponds to the field list used in the SortOn input.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the StartsWith input for this GetSeasonGroups choreography.
     *
     * @param bool $value (optional, boolean) When true, the search will only return results that begin with the specified search string. Otherwise, any match of the search string will be returned as a result.
     * @return Genability_TariffData_GetSeasonGroups_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetSeasonGroups choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetSeasonGroups_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetSeasonGroups $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetSeasonGroups_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetSeasonGroups_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetSeasonGroups execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetSeasonGroups_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetSeasonGroups choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
class Genability_TariffData_GetLoadServingEntities extends Temboo_Choreography
{
     ...
     * Returns a list of LoadServingEntity objects based a specified search criteria.
     *
     * @param Temboo_Session $session The session that owns this GetLoadServingEntities choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetLoadServingEntities choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetLoadServingEntities choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetLoadServingEntities choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetLoadServingEntities choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the AccountID input for this GetLoadServingEntities choreography.
     *
    ...
    /**
     * Set the value for the AppID input for this GetLoadServingEntities choreography.
     *
     * @param string $value (conditional, string) The App ID provided by Genability.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetLoadServingEntities choreography.
     *
     * @param string $value (required, string) The App Key provided by Genability.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the EndsWith input for this GetLoadServingEntities choreography.
     *
     * @param string $value (optional, string) When true, the search will only return results that end with the specified search string. Otherwise, any match of the search string will be returned as a result.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the IsRegex input for this GetLoadServingEntities choreography.
     *
     * @param bool $value (optional, boolean) When true, the provided search string will be regarded as a regular expression and the search will return results matching the regular expression.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageCount input for this GetLoadServingEntities choreography.
     *
     * @param int $value (optional, integer) The number of results to return. Defaults to 25.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PageStart input for this GetLoadServingEntities choreography.
     *
     * @param int $value (optional, integer) The page number to begin the result set from. Defaults to 1.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SearchOn input for this GetLoadServingEntities choreography.
     *
     * @param string $value (optional, string) Comma separated list of fields to query on. When searchOn is specified, the text provided in the search string field will be searched within these fields.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Search input for this GetLoadServingEntities choreography.
     *
     * @param string $value (optional, string) The string of text to search on. This can also be a regular expression, in which case you should set the 'isRegex' flag to true.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SortOn input for this GetLoadServingEntities choreography.
     *
     * @param string $value (optional, string) Comma separated list of fields to sort on.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SortOrder input for this GetLoadServingEntities choreography.
     *
     * @param string $value (optional, string) Comma separated list of ordering. Possible values are 'ASC' and 'DESC'. Default is 'ASC'. This list corresponds to the field list used in the SortOn input.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the StartsWith input for this GetLoadServingEntities choreography.
     *
     * @param bool $value (optional, boolean) When true, the search will only return results that begin with the specified search string. Otherwise, any match of the search string will be returned as a result.
     * @return Genability_TariffData_GetLoadServingEntities_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetLoadServingEntities choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
class Genability_TariffData_GetLoadServingEntities_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Genability_TariffData_GetLoadServingEntities $choreo The choregraphy object for this execution.
     * @param Genability_TariffData_GetLoadServingEntities_Inputs|array $inputs (optional) Inputs as Genability_TariffData_GetLoadServingEntities_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetLoadServingEntities execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Genability_TariffData_GetLoadServingEntities_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetLoadServingEntities choreography.
 *
 * @package Temboo
 * @subpackage Genability
 */
