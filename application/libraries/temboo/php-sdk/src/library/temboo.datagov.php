...
class DataGov_GetDemographicsByTypeAndID extends Temboo_Choreography
{
     ...
     * Retrieve demographic data for a specified geography type and geography ID.
     *
     * @param Temboo_Session $session The session that owns this GetDemographicsByTypeAndID choreography.
     ...
     *
     * Execution object provides access to results appropriate for this GetDemographicsByTypeAndID choreography.
     *
     ...
     *
     * Includes setters appropriate for this GetDemographicsByTypeAndID choreography.
     *
...
/**
 * Inputs object with appropriate setters for the GetDemographicsByTypeAndID choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetDemographicsByTypeAndID choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the DataVersion input for this GetDemographicsByTypeAndID choreography.
     *
    ...
    /**
     * Set the value for the GeographyIDs input for this GetDemographicsByTypeAndID choreography.
     *
    ...
    /**
     * Set the value for the GeographyType input for this GetDemographicsByTypeAndID choreography.
     *
...
/**
 * Execution object for the GetDemographicsByTypeAndID choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
class DataGov_GetDemographicsByTypeAndID_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DataGov_GetDemographicsByTypeAndID $choreo The choregraphy object for this execution.
     * @param DataGov_GetDemographicsByTypeAndID_Inputs|array $inputs (optional) Inputs as DataGov_GetDemographicsByTypeAndID_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetDemographicsByTypeAndID execution.
     *
...
/**
 * Results object with appopriate getters for the GetDemographicsByTypeAndID choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
...
class DataGov_GetCensusIDByTypeAndName extends Temboo_Choreography
{
     ...
     * Retrieve the U.S. census ID for a specified geography type and name.
     *
     * @param Temboo_Session $session The session that owns this GetCensusIDByTypeAndName choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetCensusIDByTypeAndName choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetCensusIDByTypeAndName choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetCensusIDByTypeAndName choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetCensusIDByTypeAndName choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the GeographyName input for this GetCensusIDByTypeAndName choreography.
     *
    ...
    /**
     * Set the value for the GeographyType input for this GetCensusIDByTypeAndName choreography.
     *
     * @param string $value (required, string) Specify one of the following geography type values: "state", "county", "tract", "block", "congdistrict", "statehouse", "statesenate", "censusplace", or "msa" (metropolitan statistical area).
     * @return DataGov_GetCensusIDByTypeAndName_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MaxResults input for this GetCensusIDByTypeAndName choreography.
     *
...
/**
 * Execution object for the GetCensusIDByTypeAndName choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
class DataGov_GetCensusIDByTypeAndName_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DataGov_GetCensusIDByTypeAndName $choreo The choregraphy object for this execution.
     * @param DataGov_GetCensusIDByTypeAndName_Inputs|array $inputs (optional) Inputs as DataGov_GetCensusIDByTypeAndName_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetCensusIDByTypeAndName execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return DataGov_GetCensusIDByTypeAndName_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetCensusIDByTypeAndName choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
...
class DataGov_GetCensusIDByCoordinates extends Temboo_Choreography
{
     ...
     * Retrieve the U.S. census block geography ID for a specified latitude and longitude. 
     *
     * @param Temboo_Session $session The session that owns this GetCensusIDByCoordinates choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetCensusIDByCoordinates choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetCensusIDByCoordinates choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetCensusIDByCoordinates choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetCensusIDByCoordinates choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the GeographyType input for this GetCensusIDByCoordinates choreography.
     *
     * @param string $value (required, string) Specify one of the following geography type values: "state", "county", "tract", "block", "congdistrict", "statehouse", "statesenate", "censusplace", or "msa" (metropolitan statistical area).
     * @return DataGov_GetCensusIDByCoordinates_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Latitude input for this GetCensusIDByCoordinates choreography.
     *
    ...
    /**
     * Set the value for the Longitude input for this GetCensusIDByCoordinates choreography.
     *
...
/**
 * Execution object for the GetCensusIDByCoordinates choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
class DataGov_GetCensusIDByCoordinates_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DataGov_GetCensusIDByCoordinates $choreo The choregraphy object for this execution.
     * @param DataGov_GetCensusIDByCoordinates_Inputs|array $inputs (optional) Inputs as DataGov_GetCensusIDByCoordinates_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetCensusIDByCoordinates execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return DataGov_GetCensusIDByCoordinates_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetCensusIDByCoordinates choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
...
class DataGov_GetDemographicsByCoordinates extends Temboo_Choreography
{
     ...
     * Retrieve demographic information for specified geographical coordinates.
     *
     * @param Temboo_Session $session The session that owns this GetDemographicsByCoordinates choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetDemographicsByCoordinates choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetDemographicsByCoordinates choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetDemographicsByCoordinates choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetDemographicsByCoordinates choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the DataVersion input for this GetDemographicsByCoordinates choreography.
     *
    ...
    /**
     * Set the value for the Latitude input for this GetDemographicsByCoordinates choreography.
     *
     * @param float $value (required, decimal) Specify a latitude to search for, such as "41.486857".
     * @return DataGov_GetDemographicsByCoordinates_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Longitude input for this GetDemographicsByCoordinates choreography.
     *
     * @param float $value (required, decimal) Specify a longitude to search for, such as "-71.294392".
     * @return DataGov_GetDemographicsByCoordinates_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetDemographicsByCoordinates choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
class DataGov_GetDemographicsByCoordinates_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DataGov_GetDemographicsByCoordinates $choreo The choregraphy object for this execution.
     * @param DataGov_GetDemographicsByCoordinates_Inputs|array $inputs (optional) Inputs as DataGov_GetDemographicsByCoordinates_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetDemographicsByCoordinates execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return DataGov_GetDemographicsByCoordinates_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetDemographicsByCoordinates choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
...
class DataGov_GetDemographicsForNation extends Temboo_Choreography
{
     ...
     * Retrieve demographic information for the entire nation.
     *
     * @param Temboo_Session $session The session that owns this GetDemographicsForNation choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetDemographicsForNation choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetDemographicsForNation choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetDemographicsForNation choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetDemographicsForNation choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the DataVersion input for this GetDemographicsForNation choreography.
     *
     * @param string $value (optional, string) Specify the census data version to search, such as "jun2011" (the default).
     * @return DataGov_GetDemographicsForNation_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetDemographicsForNation choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
class DataGov_GetDemographicsForNation_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param DataGov_GetDemographicsForNation $choreo The choregraphy object for this execution.
     * @param DataGov_GetDemographicsForNation_Inputs|array $inputs (optional) Inputs as DataGov_GetDemographicsForNation_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetDemographicsForNation execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return DataGov_GetDemographicsForNation_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetDemographicsForNation choreography.
 *
 * @package Temboo
 * @subpackage DataGov
 */
