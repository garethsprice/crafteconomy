...
class BrighterPlanet_AutomobileTrip extends Temboo_Choreography
{
     ...
     * Returns information about the carbon footprint of driving an automobile.
     *
     * @param Temboo_Session $session The session that owns this AutomobileTrip choreography.
     ...
     *
     * Execution object provides access to results appropriate for this AutomobileTrip choreography.
     *
     ...
     *
     * Includes setters appropriate for this AutomobileTrip choreography.
     *
...
/**
 * Inputs object with appropriate setters for the AutomobileTrip choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the AutomobileTrip choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the AutomobileFuel input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Country input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Date input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Destination input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Distance input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Duration input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the FuelEfficiency input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the FuelUse input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Hybridity input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Make input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Model input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the SizeClass input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Speed input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Urbanity input for this AutomobileTrip choreography.
     *
    ...
    /**
     * Set the value for the Year input for this AutomobileTrip choreography.
     *
...
/**
 * Execution object for the AutomobileTrip choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_AutomobileTrip_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_AutomobileTrip $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_AutomobileTrip_Inputs|array $inputs (optional) Inputs as BrighterPlanet_AutomobileTrip_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this AutomobileTrip execution.
     *
...
/**
 * Results object with appopriate getters for the AutomobileTrip choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_Diet extends Temboo_Choreography
{
     ...
     * Returns information about the carbon footprint of an individual's yearly food consumption.
     *
     * @param Temboo_Session $session The session that owns this Diet choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Diet choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Diet choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Diet choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the Diet choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Diet choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_Diet_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DietClass input for this Diet choreography.
     *
    ...
    /**
     * Set the value for the EndDate input for this Diet choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Diet choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_Diet_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Size input for this Diet choreography.
     *
    ...
    /**
     * Set the value for the StartDate input for this Diet choreography.
     *
...
/**
 * Execution object for the Diet choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_Diet_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_Diet $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_Diet_Inputs|array $inputs (optional) Inputs as BrighterPlanet_Diet_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Diet execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_Diet_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Diet choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_Meeting extends Temboo_Choreography
{
     ...
     * Returns facility operations emissions analysis for corporate and cultural events.
     *
     * @param Temboo_Session $session The session that owns this Meeting choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Meeting choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Meeting choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Meeting choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the Meeting choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Meeting choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_Meeting_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Area input for this Meeting choreography.
     *
    ...
    /**
     * Set the value for the Date input for this Meeting choreography.
     *
    ...
    /**
     * Set the value for the Duration input for this Meeting choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Meeting choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_Meeting_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the State input for this Meeting choreography.
     *
    ...
    /**
     * Set the value for the Zip input for this Meeting choreography.
     *
...
/**
 * Execution object for the Meeting choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_Meeting_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_Meeting $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_Meeting_Inputs|array $inputs (optional) Inputs as BrighterPlanet_Meeting_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Meeting execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_Meeting_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Meeting choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_ElectricityUse extends Temboo_Choreography
{
     ...
     * Returns information about the carbon footprint of using electricity from the US public grid.
     *
     * @param Temboo_Session $session The session that owns this ElectricityUse choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this ElectricityUse choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ElectricityUse choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the ElectricityUse choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the ElectricityUse choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this ElectricityUse choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_ElectricityUse_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Country input for this ElectricityUse choreography.
     *
    ...
    /**
     * Set the value for the Date input for this ElectricityUse choreography.
     *
    ...
    /**
     * Set the value for the Energy input for this ElectricityUse choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this ElectricityUse choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_ElectricityUse_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the State input for this ElectricityUse choreography.
     *
    ...
    /**
     * Set the value for the Timeframe input for this ElectricityUse choreography.
     *
    ...
    /**
     * Set the value for the ZipCode input for this ElectricityUse choreography.
     *
...
/**
 * Execution object for the ElectricityUse choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_ElectricityUse_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_ElectricityUse $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_ElectricityUse_Inputs|array $inputs (optional) Inputs as BrighterPlanet_ElectricityUse_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ElectricityUse execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_ElectricityUse_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the ElectricityUse choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_Purchase extends Temboo_Choreography
{
     ...
     * Returns lifecycle emissions for any good or service. 
     *
     * @param Temboo_Session $session The session that owns this Purchase choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Purchase choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Purchase choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Purchase choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the Purchase choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Purchase choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_Purchase_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Cost input for this Purchase choreography.
     *
    ...
    /**
     * Set the value for the Date input for this Purchase choreography.
     *
    ...
    /**
     * Set the value for the Industry input for this Purchase choreography.
     *
    ...
    /**
     * Set the value for the MerchantCategory input for this Purchase choreography.
     *
    ...
    /**
     * Set the value for the Merchant input for this Purchase choreography.
     *
    ...
    /**
     * Set the value for the PurchaseAmount input for this Purchase choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Purchase choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_Purchase_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the SicIndustry input for this Purchase choreography.
     *
    ...
    /**
     * Set the value for the Tax input for this Purchase choreography.
     *
    ...
    /**
     * Set the value for the Timeframe input for this Purchase choreography.
     *
     * @param string $value (optional, string) A date range specified in the following format: 2008-01-01/2008-07-09
     * @return BrighterPlanet_Purchase_Inputs For method chaining.
     */
...
/**
 * Execution object for the Purchase choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_Purchase_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_Purchase $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_Purchase_Inputs|array $inputs (optional) Inputs as BrighterPlanet_Purchase_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Purchase execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_Purchase_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Purchase choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_Shipment extends Temboo_Choreography
{
     ...
     * Returns information about the carbon footprint of shipping packages.
     *
     * @param Temboo_Session $session The session that owns this Shipment choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Shipment choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Shipment choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Shipment choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the Shipment choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Shipment choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_Shipment_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Carrier input for this Shipment choreography.
     *
    ...
    /**
     * Set the value for the DestinationZipCode input for this Shipment choreography.
     *
    ...
    /**
     * Set the value for the Destination input for this Shipment choreography.
     *
    ...
    /**
     * Set the value for the Distance input for this Shipment choreography.
     *
    ...
    /**
     * Set the value for the Mode input for this Shipment choreography.
     *
    ...
    /**
     * Set the value for the OriginZipCode input for this Shipment choreography.
     *
    ...
    /**
     * Set the value for the Origin input for this Shipment choreography.
     *
    ...
    /**
     * Set the value for the PackageCount input for this Shipment choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Shipment choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_Shipment_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Weight input for this Shipment choreography.
     *
...
/**
 * Execution object for the Shipment choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_Shipment_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_Shipment $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_Shipment_Inputs|array $inputs (optional) Inputs as BrighterPlanet_Shipment_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Shipment execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_Shipment_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Shipment choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_FuelPurchase extends Temboo_Choreography
{
     ...
     * Returns information about the carbon emissions from using a wide variety of fuel types.
     *
     * @param Temboo_Session $session The session that owns this FuelPurchase choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this FuelPurchase choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this FuelPurchase choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the FuelPurchase choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the FuelPurchase choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this FuelPurchase choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_FuelPurchase_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Cost input for this FuelPurchase choreography.
     *
    ...
    /**
     * Set the value for the Date input for this FuelPurchase choreography.
     *
    ...
    /**
     * Set the value for the FuelType input for this FuelPurchase choreography.
     *
    ...
    /**
     * Set the value for the PADD input for this FuelPurchase choreography.
     *
    ...
    /**
     * Set the value for the Price input for this FuelPurchase choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this FuelPurchase choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_FuelPurchase_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the State input for this FuelPurchase choreography.
     *
    ...
    /**
     * Set the value for the Timeframe input for this FuelPurchase choreography.
     *
     * @param string $value (optional, string) A date range specified in the following format: 2008-01-01/2008-07-09
     * @return BrighterPlanet_FuelPurchase_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Volume input for this FuelPurchase choreography.
     *
    ...
    /**
     * Set the value for the ZipCode input for this FuelPurchase choreography.
     *
...
/**
 * Execution object for the FuelPurchase choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_FuelPurchase_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_FuelPurchase $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_FuelPurchase_Inputs|array $inputs (optional) Inputs as BrighterPlanet_FuelPurchase_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this FuelPurchase execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_FuelPurchase_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the FuelPurchase choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_Automobile extends Temboo_Choreography
{
     ...
     * Returns greenhouse gas modeling for passenger vehicles operated over periods of time.
     *
     * @param Temboo_Session $session The session that owns this Automobile choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Automobile choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Automobile choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Automobile choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the Automobile choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Automobile choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Acquisition input for this Automobile choreography.
     *
    ...
    /**
     * Set the value for the AnnualDistance input for this Automobile choreography.
     *
    ...
    /**
     * Set the value for the AnnualFuelUse input for this Automobile choreography.
     *
    ...
    /**
     * Set the value for the AutomobileFuel input for this Automobile choreography.
     *
     * @param string $value (optional, string) Fuel used by automobile (e.g. regular gasoline).
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Country input for this Automobile choreography.
     *
     * @param string $value (optional, string) ISO code of the country. Defaults to 3166.
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DailyDistance input for this Automobile choreography.
     *
    ...
    /**
     * Set the value for the DailyDuration input for this Automobile choreography.
     *
    ...
    /**
     * Set the value for the FuelEfficiency input for this Automobile choreography.
     *
     * @param float $value (optional, decimal) The automobile's fuel efficiency in kilometres per litre.
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the FuelUse input for this Automobile choreography.
     *
     * @param float $value (optional, decimal) Amount of fuel used in litres.
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Hybridity input for this Automobile choreography.
     *
     * @param bool $value (optional, boolean) Enter whether the automobile is a hybrid.
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Make input for this Automobile choreography.
     *
     * @param string $value (optional, string) Automobile make (e.g. Honda).
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Model input for this Automobile choreography.
     *
     * @param string $value (optional, string) Model of automobile (e.g. Civic, Accord).
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this Automobile choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Retirement input for this Automobile choreography.
     *
    ...
    /**
     * Set the value for the SizeClass input for this Automobile choreography.
     *
     * @param string $value (optional, string) Automobile size class (e.g. midsize car, large van).
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Speed input for this Automobile choreography.
     *
    ...
    /**
     * Set the value for the Urbanity input for this Automobile choreography.
     *
     * @param bool $value (optional, boolean) Enter whether the trip is in an urban area.
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the WeeklyDistance input for this Automobile choreography.
     *
    ...
    /**
     * Set the value for the Year input for this Automobile choreography.
     *
     * @param int $value (optional, integer) Year that automobile was manufactured.
     * @return BrighterPlanet_Automobile_Inputs For method chaining.
     */
...
/**
 * Execution object for the Automobile choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_Automobile_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_Automobile $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_Automobile_Inputs|array $inputs (optional) Inputs as BrighterPlanet_Automobile_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Automobile execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_Automobile_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Automobile choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_Pet extends Temboo_Choreography
{
     ...
     * Returns lifecycle food production and veterinary care emissions modeling for domestic animals.
     *
     * @param Temboo_Session $session The session that owns this Pet choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Pet choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Pet choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Pet choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the Pet choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Pet choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_Pet_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Acquisition input for this Pet choreography.
     *
    ...
    /**
     * Set the value for the Breed input for this Pet choreography.
     *
    ...
    /**
     * Set the value for the Gender input for this Pet choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Pet choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_Pet_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Retirement input for this Pet choreography.
     *
    ...
    /**
     * Set the value for the Species input for this Pet choreography.
     *
    ...
    /**
     * Set the value for the Weight input for this Pet choreography.
     *
...
/**
 * Execution object for the Pet choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_Pet_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_Pet $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_Pet_Inputs|array $inputs (optional) Inputs as BrighterPlanet_Pet_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Pet execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_Pet_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Pet choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_BusTrip extends Temboo_Choreography
{
     ...
     * Returns information about the carbon footprint of passenger bus travel.
     *
     * @param Temboo_Session $session The session that owns this BusTrip choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this BusTrip choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this BusTrip choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the BusTrip choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the BusTrip choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this BusTrip choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_BusTrip_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the BusClass input for this BusTrip choreography.
     *
    ...
    /**
     * Set the value for the Compliance input for this BusTrip choreography.
     *
    ...
    /**
     * Set the value for the Date input for this BusTrip choreography.
     *
    ...
    /**
     * Set the value for the Distance input for this BusTrip choreography.
     *
    ...
    /**
     * Set the value for the Duration input for this BusTrip choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this BusTrip choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_BusTrip_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Timeframe input for this BusTrip choreography.
     *
     * @param string $value (optional, string) A date range specified in the following format: 2008-01-01/2008-07-09
     * @return BrighterPlanet_BusTrip_Inputs For method chaining.
     */
...
/**
 * Execution object for the BusTrip choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_BusTrip_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_BusTrip $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_BusTrip_Inputs|array $inputs (optional) Inputs as BrighterPlanet_BusTrip_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this BusTrip execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_BusTrip_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the BusTrip choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_Flight extends Temboo_Choreography
{
     ...
     * Returns information about the carbon footprint of a passenger's air travel.
     *
     * @param Temboo_Session $session The session that owns this Flight choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Flight choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Flight choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Flight choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the Flight choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Flight choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_Flight_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Aircraft input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the Airline input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the Compliance input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the Date input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the DestinationAirport input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the DistanceClass input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the DistanceEstimate input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the Fuel input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the OriginAirport input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Flight choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_Flight_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Seats input for this Flight choreography.
     *
    ...
    /**
     * Set the value for the Timeframe input for this Flight choreography.
     *
     * @param string $value (optional, string) A date range specified in the following format: 2008-01-01/2008-07-09
     * @return BrighterPlanet_Flight_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Trips input for this Flight choreography.
     *
...
/**
 * Execution object for the Flight choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_Flight_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_Flight $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_Flight_Inputs|array $inputs (optional) Inputs as BrighterPlanet_Flight_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Flight execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_Flight_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Flight choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_RailTrip extends Temboo_Choreography
{
     ...
     * Returns information about the carbon footprint of a passenger's train travel.
     *
     * @param Temboo_Session $session The session that owns this RailTrip choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this RailTrip choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this RailTrip choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the RailTrip choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the RailTrip choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this RailTrip choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_RailTrip_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Compliance input for this RailTrip choreography.
     *
     * @param string $value (optional, string) Comply with one or more protocols:  Greenhouse Gas Protocol Scope 3 (ghg_protocol_scope_3), ISO 14064-1 (iso), and The Climate Registry (tcr).
     * @return BrighterPlanet_RailTrip_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Country input for this RailTrip choreography.
     *
    ...
    /**
     * Set the value for the Date input for this RailTrip choreography.
     *
    ...
    /**
     * Set the value for the Destination input for this RailTrip choreography.
     *
    ...
    /**
     * Set the value for the Distance input for this RailTrip choreography.
     *
    ...
    /**
     * Set the value for the Duration input for this RailTrip choreography.
     *
    ...
    /**
     * Set the value for the Origin input for this RailTrip choreography.
     *
    ...
    /**
     * Set the value for the RailClass input for this RailTrip choreography.
     *
    ...
    /**
     * Set the value for the RailCompany input for this RailTrip choreography.
     *
    ...
    /**
     * Set the value for the RailTraction input for this RailTrip choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this RailTrip choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_RailTrip_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Timeframe input for this RailTrip choreography.
     *
     * @param string $value (optional, string) A date range specified in the following format: 2008-01-01/2008-07-09
     * @return BrighterPlanet_RailTrip_Inputs For method chaining.
     */
...
/**
 * Execution object for the RailTrip choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_RailTrip_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_RailTrip $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_RailTrip_Inputs|array $inputs (optional) Inputs as BrighterPlanet_RailTrip_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this RailTrip execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_RailTrip_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the RailTrip choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_GetReferenceData extends Temboo_Choreography
{
     ...
     * Retrieves a wide variety of reference data sets provided by Brighter Planet.
     *
     * @param Temboo_Session $session The session that owns this GetReferenceData choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetReferenceData choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetReferenceData choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetReferenceData choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetReferenceData choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Resource input for this GetReferenceData choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this GetReferenceData choreography.
     *
...
/**
 * Execution object for the GetReferenceData choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_GetReferenceData_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_GetReferenceData $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_GetReferenceData_Inputs|array $inputs (optional) Inputs as BrighterPlanet_GetReferenceData_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetReferenceData execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_GetReferenceData_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetReferenceData choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_Residence extends Temboo_Choreography
{
     ...
     * Returns information about the annual carbon footprint of a home.
     *
     * @param Temboo_Session $session The session that owns this Residence choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Residence choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Residence choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Residence choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the Residence choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Residence choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_Residence_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Acquisition input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the AirConditionerUse input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the AnnualCoalVolumeEstimate input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the AnnualFuelOilCost input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the AnnualFuelOilVolumeEstimate input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the AnnualPropaneCost input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the AnnualPropaneVolumeEstimate input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the AnnualWoodVolumeEstimate input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the Bathrooms input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the Bedrooms input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the ClothesMachineUse input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the ConstructionYear input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the DishwasherUse input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the Floors input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the FloorspaceEstimate input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the FreezerCount input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the FullBathrooms input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the GreenElectricty input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the HalfBathrooms input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the LightingEfficiency input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the MonthlyElectricityCost input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the MonthlyElectricityUseEstimate input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the MonthlyNaturalGasCost input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the MonthlyNaturalGasVolumeEstimate input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the Occupation input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the Ownership input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the RefrigeratorCount input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the ResidentialClass input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the Residents input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Residence choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_Residence_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Retirement input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the Timeframe input for this Residence choreography.
     *
     * @param string $value (optional, string) A date range specified in the following format: 2008-01-01/2008-07-09
     * @return BrighterPlanet_Residence_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Urbanity input for this Residence choreography.
     *
    ...
    /**
     * Set the value for the ZipCode input for this Residence choreography.
     *
...
/**
 * Execution object for the Residence choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_Residence_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_Residence $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_Residence_Inputs|array $inputs (optional) Inputs as BrighterPlanet_Residence_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Residence execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_Residence_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Residence choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
class BrighterPlanet_Lodging extends Temboo_Choreography
{
     ...
     * Returns the the footprint of a guest's hotel stay.
     *
     * @param Temboo_Session $session The session that owns this Lodging choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Lodging choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Lodging choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Lodging choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
...
{
   /**
     * Inputs object with appopriate setters for the Lodging choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the ACCoverage input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the APIKey input for this Lodging choreography.
     *
     * @param string $value (required, string) The API Key provided by Brighter Planet.
     * @return BrighterPlanet_Lodging_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the City input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the Compliance input for this Lodging choreography.
     *
     * @param string $value (optional, string) Comply with one or more protocols:  Greenhouse Gas Protocol Scope 3 (ghg_protocol_scope_3), ISO 14064-1 (iso), and The Climate Registry (tcr).
     * @return BrighterPlanet_Lodging_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ConstructionYear input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the Country input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the Date input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the Duration input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the Floors input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the HotTubs input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the IndoorPools input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the LodgingClass input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the OutdoorPools input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the PropertyRooms input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the Property input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this Lodging choreography.
     *
     * @param string $value (optional, string) Specify your desired response format. Accepted values are xml and json (the default).
     * @return BrighterPlanet_Lodging_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Rooms input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the State input for this Lodging choreography.
     *
    ...
    /**
     * Set the value for the Timeframe input for this Lodging choreography.
     *
     * @param string $value (optional, string) A date range specified in the following format: 2008-01-01/2008-07-09
     * @return BrighterPlanet_Lodging_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ZipCode input for this Lodging choreography.
     *
...
/**
 * Execution object for the Lodging choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
class BrighterPlanet_Lodging_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param BrighterPlanet_Lodging $choreo The choregraphy object for this execution.
     * @param BrighterPlanet_Lodging_Inputs|array $inputs (optional) Inputs as BrighterPlanet_Lodging_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Lodging execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return BrighterPlanet_Lodging_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Lodging choreography.
 *
 * @package Temboo
 * @subpackage BrighterPlanet
 */
