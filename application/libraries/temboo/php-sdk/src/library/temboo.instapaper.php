...
class Instapaper_AddURL extends Temboo_Choreography
{
     ...
     * Add a document to an Instapaper account.
     *
     * @param Temboo_Session $session The session that owns this AddURL choreography.
     ...
     *
     * Execution object provides access to results appropriate for this AddURL choreography.
     *
     ...
     *
     * Includes setters appropriate for this AddURL choreography.
     *
...
/**
 * Inputs object with appropriate setters for the AddURL choreography.
 *
 * @package Temboo
 * @subpackage Instapaper
 */
...
{
   /**
     * Inputs object with appopriate setters for the AddURL choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Password input for this AddURL choreography.
     *
    ...
    /**
     * Set the value for the Selection input for this AddURL choreography.
     *
    ...
    /**
     * Set the value for the Title input for this AddURL choreography.
     *
    ...
    /**
     * Set the value for the URL input for this AddURL choreography.
     *
    ...
    /**
     * Set the value for the Username input for this AddURL choreography.
     *
...
/**
 * Execution object for the AddURL choreography.
 *
 * @package Temboo
 * @subpackage Instapaper
 */
class Instapaper_AddURL_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Instapaper_AddURL $choreo The choregraphy object for this execution.
     * @param Instapaper_AddURL_Inputs|array $inputs (optional) Inputs as Instapaper_AddURL_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this AddURL execution.
     *
...
/**
 * Results object with appopriate getters for the AddURL choreography.
 *
 * @package Temboo
 * @subpackage Instapaper
 */
...
class Instapaper_Authenticate extends Temboo_Choreography
{
     ...
     * Validate an Instapaper account.
     *
     * @param Temboo_Session $session The session that owns this Authenticate choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Authenticate choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Authenticate choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Authenticate choreography.
 *
 * @package Temboo
 * @subpackage Instapaper
 */
...
{
   /**
     * Inputs object with appopriate setters for the Authenticate choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Password input for this Authenticate choreography.
     *
     * @param string $value (required, string) Your Instapaper password.
     * @return Instapaper_Authenticate_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this Authenticate choreography.
     *
     * @param string $value (required, string) Your Instapaper username.
     * @return Instapaper_Authenticate_Inputs For method chaining.
     */
...
/**
 * Execution object for the Authenticate choreography.
 *
 * @package Temboo
 * @subpackage Instapaper
 */
class Instapaper_Authenticate_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Instapaper_Authenticate $choreo The choregraphy object for this execution.
     * @param Instapaper_Authenticate_Inputs|array $inputs (optional) Inputs as Instapaper_Authenticate_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Authenticate execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Instapaper_Authenticate_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Authenticate choreography.
 *
 * @package Temboo
 * @subpackage Instapaper
 */
