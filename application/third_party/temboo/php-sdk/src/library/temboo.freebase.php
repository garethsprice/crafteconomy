...
class Freebase_Text extends Temboo_Choreography
{
     ...
     * Access Freebase topic and schema descriptions.
     *
     * @param Temboo_Session $session The session that owns this Text choreography.
     ...
     *
     * Execution object provides access to results appropriate for this Text choreography.
     *
     ...
     *
     * Includes setters appropriate for this Text choreography.
     *
...
/**
 * Inputs object with appropriate setters for the Text choreography.
 *
 * @package Temboo
 * @subpackage Freebase
 */
...
{
   /**
     * Inputs object with appopriate setters for the Text choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Text choreography.
     *
    ...
    /**
     * Set the value for the Format input for this Text choreography.
     *
    ...
    /**
     * Set the value for the ID input for this Text choreography.
     *
    ...
    /**
     * Set the value for the Language input for this Text choreography.
     *
    ...
    /**
     * Set the value for the MaximumLength input for this Text choreography.
     *
...
/**
 * Execution object for the Text choreography.
 *
 * @package Temboo
 * @subpackage Freebase
 */
class Freebase_Text_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Freebase_Text $choreo The choregraphy object for this execution.
     * @param Freebase_Text_Inputs|array $inputs (optional) Inputs as Freebase_Text_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Text execution.
     *
...
/**
 * Results object with appopriate getters for the Text choreography.
 *
 * @package Temboo
 * @subpackage Freebase
 */
...
class Freebase_MQLRead extends Temboo_Choreography
{
     ...
     * Search the Freebase dataset using the Metaweb query language (MQL).
     *
     * @param Temboo_Session $session The session that owns this MQLRead choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this MQLRead choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this MQLRead choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the MQLRead choreography.
 *
 * @package Temboo
 * @subpackage Freebase
 */
...
{
   /**
     * Inputs object with appopriate setters for the MQLRead choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this MQLRead choreography.
     *
     * @param string $value (required, string) The API Key provided by Freebase.
     * @return Freebase_MQLRead_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AsOfTime input for this MQLRead choreography.
     *
    ...
    /**
     * Set the value for the Cost input for this MQLRead choreography.
     *
    ...
    /**
     * Set the value for the Cursor input for this MQLRead choreography.
     *
    ...
    /**
     * Set the value for the EscapeHTMLResults input for this MQLRead choreography.
     *
    ...
    /**
     * Set the value for the Indent input for this MQLRead choreography.
     *
    ...
    /**
     * Set the value for the Language input for this MQLRead choreography.
     *
    ...
    /**
     * Set the value for the Query input for this MQLRead choreography.
     *
    ...
    /**
     * Set the value for the UniqenessFailure input for this MQLRead choreography.
     *
...
/**
 * Execution object for the MQLRead choreography.
 *
 * @package Temboo
 * @subpackage Freebase
 */
class Freebase_MQLRead_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Freebase_MQLRead $choreo The choregraphy object for this execution.
     * @param Freebase_MQLRead_Inputs|array $inputs (optional) Inputs as Freebase_MQLRead_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this MQLRead execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Freebase_MQLRead_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the MQLRead choreography.
 *
 * @package Temboo
 * @subpackage Freebase
 */
...
class Freebase_Image extends Temboo_Choreography
{
     ...
     * Generates a thumbnail for an image from the content database to the requested size. 
     *
     * @param Temboo_Session $session The session that owns this Image choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this Image choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Image choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the Image choreography.
 *
 * @package Temboo
 * @subpackage Freebase
 */
...
{
   /**
     * Inputs object with appopriate setters for the Image choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this Image choreography.
     *
     * @param string $value (required, string) The API Key provided by Freebase.
     * @return Freebase_Image_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the FallbackID input for this Image choreography.
     *
    ...
    /**
     * Set the value for the ID input for this Image choreography.
     *
     * @param string $value (required, string) Enter the ID of the entity for which description information will be retrieved. IDs and MIDs can be obtained by running the Search Choreo in this bundle. Example input: /en/bob_dylan
     * @return Freebase_Image_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MaximumHeight input for this Image choreography.
     *
    ...
    /**
     * Set the value for the MaximumWidth input for this Image choreography.
     *
    ...
    /**
     * Set the value for the Mode input for this Image choreography.
     *
    ...
    /**
     * Set the value for the Pad input for this Image choreography.
     *
...
/**
 * Execution object for the Image choreography.
 *
 * @package Temboo
 * @subpackage Freebase
 */
class Freebase_Image_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Freebase_Image $choreo The choregraphy object for this execution.
     * @param Freebase_Image_Inputs|array $inputs (optional) Inputs as Freebase_Image_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this Image execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Freebase_Image_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the Image choreography.
 *
 * @package Temboo
 * @subpackage Freebase
 */
...
class Freebase_Search_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the Domain input for this Search choreography.
     *
    ...
    /**
     * Set the value for the EscapeHTMLResults input for this Search choreography.
     *
     * @param bool $value (optional, boolean) Specify whether html results are to be escaped or not.  Default is set to: true.
     * @return Freebase_Search_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Exact input for this Search choreography.
     *
    ...
    /**
     * Set the value for the Filter input for this Search choreography.
     *
    ...
    /**
     * Set the value for the Indent input for this Search choreography.
     *
    ...
    /**
     * Set the value for the MQLOutput input for this Search choreography.
     *
    ...
    /**
     * Set the value for the Prefixed input for this Search choreography.
     *
    ...
    /**
     * Set the value for the Start input for this Search choreography.
     *
    ...
    /**
     * Set the value for the Type input for this Search choreography.
     *
...
class Freebase_Search_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Freebase_Search $choreo The choregraphy object for this execution.
     * @param Freebase_Search_Inputs|array $inputs (optional) Inputs as Freebase_Search_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
