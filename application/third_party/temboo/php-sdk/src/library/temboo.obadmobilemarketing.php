...
class ObadMobileMarketing_EditCoupon extends Temboo_Choreography
{
     ...
     * Allows you to create a new coupon or update an existing one.
     *
     * @param Temboo_Session $session The session that owns this EditCoupon choreography.
     ...
     *
     * Execution object provides access to results appropriate for this EditCoupon choreography.
     *
     ...
     *
     * Includes setters appropriate for this EditCoupon choreography.
     *
...
/**
 * Inputs object with appropriate setters for the EditCoupon choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
{
   /**
     * Inputs object with appopriate setters for the EditCoupon choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the ClientID input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the CouponId input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the Desc1 input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the Desc2 input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the Desc3 input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the Endpoint input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the From input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the Mode input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the Title input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the To input for this EditCoupon choreography.
     *
    ...
    /**
     * Set the value for the UseOnce input for this EditCoupon choreography.
     *
...
/**
 * Execution object for the EditCoupon choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
class ObadMobileMarketing_EditCoupon_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param ObadMobileMarketing_EditCoupon $choreo The choregraphy object for this execution.
     * @param ObadMobileMarketing_EditCoupon_Inputs|array $inputs (optional) Inputs as ObadMobileMarketing_EditCoupon_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this EditCoupon execution.
     *
...
/**
 * Results object with appopriate getters for the EditCoupon choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
class ObadMobileMarketing_AddCSVData extends Temboo_Choreography
{
     ...
     * Transfer a csv file to add records to a specified group.
     *
     * @param Temboo_Session $session The session that owns this AddCSVData choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this AddCSVData choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this AddCSVData choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the AddCSVData choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
{
   /**
     * Inputs object with appopriate setters for the AddCSVData choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this AddCSVData choreography.
     *
     * @param string $value (string) Private Key for 1 unique distributor - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_AddCSVData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ClientID input for this AddCSVData choreography.
     *
     * @param int $value (integer) Private Key for 1 unique customer to connect with - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_AddCSVData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Endpoint input for this AddCSVData choreography.
     *
     * @param string $value (string) The base URL for the server you want to access (i.e. http://10.10.10.1). Set this to the appropriate host for the demo sandbox or production.
     * @return ObadMobileMarketing_AddCSVData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the GroupID input for this AddCSVData choreography.
     *
    ...
    /**
     * Set the value for the Type input for this AddCSVData choreography.
     *
    ...
    /**
     * Set the value for the URLSource input for this AddCSVData choreography.
     *
...
/**
 * Execution object for the AddCSVData choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
class ObadMobileMarketing_AddCSVData_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param ObadMobileMarketing_AddCSVData $choreo The choregraphy object for this execution.
     * @param ObadMobileMarketing_AddCSVData_Inputs|array $inputs (optional) Inputs as ObadMobileMarketing_AddCSVData_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this AddCSVData execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return ObadMobileMarketing_AddCSVData_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the AddCSVData choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
class ObadMobileMarketing_ImageCoupon extends Temboo_Choreography
{
     ...
     * Transfer an image for updating the coupon or coupon burn.
     *
     * @param Temboo_Session $session The session that owns this ImageCoupon choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this ImageCoupon choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ImageCoupon choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the ImageCoupon choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
{
   /**
     * Inputs object with appopriate setters for the ImageCoupon choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this ImageCoupon choreography.
     *
     * @param string $value (string) Private Key for 1 unique distributor - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_ImageCoupon_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ClientID input for this ImageCoupon choreography.
     *
     * @param int $value (integer) Private Key for 1 unique customer to connect with - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_ImageCoupon_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the CouponID input for this ImageCoupon choreography.
     *
    ...
    /**
     * Set the value for the Endpoint input for this ImageCoupon choreography.
     *
     * @param string $value (string) The base URL for the server you want to access (i.e. http://10.10.10.1). Set this to the appropriate host for the demo sandbox or production.
     * @return ObadMobileMarketing_ImageCoupon_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Type input for this ImageCoupon choreography.
     *
    ...
    /**
     * Set the value for the URLSource input for this ImageCoupon choreography.
     *
...
/**
 * Execution object for the ImageCoupon choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
class ObadMobileMarketing_ImageCoupon_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param ObadMobileMarketing_ImageCoupon $choreo The choregraphy object for this execution.
     * @param ObadMobileMarketing_ImageCoupon_Inputs|array $inputs (optional) Inputs as ObadMobileMarketing_ImageCoupon_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ImageCoupon execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return ObadMobileMarketing_ImageCoupon_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the ImageCoupon choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
class ObadMobileMarketing_CouponGroupData extends Temboo_Choreography
{
     ...
     * Allows you to add or remove a coupon from a coupon group.
     *
     * @param Temboo_Session $session The session that owns this CouponGroupData choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this CouponGroupData choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this CouponGroupData choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the CouponGroupData choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
{
   /**
     * Inputs object with appopriate setters for the CouponGroupData choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this CouponGroupData choreography.
     *
     * @param string $value (string) Private Key for 1 unique distributor - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_CouponGroupData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ClientID input for this CouponGroupData choreography.
     *
     * @param int $value (integer) Private Key for 1 unique customer to connect with - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_CouponGroupData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the CouponGroupID input for this CouponGroupData choreography.
     *
    ...
    /**
     * Set the value for the CouponID input for this CouponGroupData choreography.
     *
    ...
    /**
     * Set the value for the Endpoint input for this CouponGroupData choreography.
     *
     * @param string $value (string) The base URL for the server you want to access (i.e. http://10.10.10.1). Set this to the appropriate host for the demo sandbox or production.
     * @return ObadMobileMarketing_CouponGroupData_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Mode input for this CouponGroupData choreography.
     *
...
/**
 * Execution object for the CouponGroupData choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
class ObadMobileMarketing_CouponGroupData_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param ObadMobileMarketing_CouponGroupData $choreo The choregraphy object for this execution.
     * @param ObadMobileMarketing_CouponGroupData_Inputs|array $inputs (optional) Inputs as ObadMobileMarketing_CouponGroupData_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this CouponGroupData execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return ObadMobileMarketing_CouponGroupData_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the CouponGroupData choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
class ObadMobileMarketing_ImageCampaign extends Temboo_Choreography
{
     ...
     * Transfer an image for updating the email body image or the wap banner of a campaign.
     *
     * @param Temboo_Session $session The session that owns this ImageCampaign choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this ImageCampaign choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ImageCampaign choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the ImageCampaign choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
{
   /**
     * Inputs object with appopriate setters for the ImageCampaign choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this ImageCampaign choreography.
     *
     * @param string $value (string) Private Key for 1 unique distributor - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_ImageCampaign_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the CampaignID input for this ImageCampaign choreography.
     *
    ...
    /**
     * Set the value for the ClientID input for this ImageCampaign choreography.
     *
     * @param int $value (integer) Private Key for 1 unique customer to connect with - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_ImageCampaign_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Endpoint input for this ImageCampaign choreography.
     *
     * @param string $value (string) The base URL for the server you want to access (i.e. http://10.10.10.1). Set this to the appropriate host for the demo sandbox or production.
     * @return ObadMobileMarketing_ImageCampaign_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Type input for this ImageCampaign choreography.
     *
    ...
    /**
     * Set the value for the URLSource input for this ImageCampaign choreography.
     *
     * @param string $value (string) The URL where you are hosting the JPG file (i.e. http://mybucket.s3.amazonaws.com/my_image.jpg)
     * @return ObadMobileMarketing_ImageCampaign_Inputs For method chaining.
     */
...
/**
 * Execution object for the ImageCampaign choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
class ObadMobileMarketing_ImageCampaign_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param ObadMobileMarketing_ImageCampaign $choreo The choregraphy object for this execution.
     * @param ObadMobileMarketing_ImageCampaign_Inputs|array $inputs (optional) Inputs as ObadMobileMarketing_ImageCampaign_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this ImageCampaign execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return ObadMobileMarketing_ImageCampaign_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the ImageCampaign choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
class ObadMobileMarketing_GetList_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the ClientID input for this GetList choreography.
     *
     * @param int $value (integer) Private Key for 1 unique customer to connect with - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_GetList_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Endpoint input for this GetList choreography.
     *
     * @param string $value (string) The base URL for the server you want to access (i.e. http://10.10.10.1). Set this to the appropriate host for the demo sandbox or production.
     * @return ObadMobileMarketing_GetList_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ID input for this GetList choreography.
     *
    ...
    /**
     * Set the value for the Type input for this GetList choreography.
     *
...
class ObadMobileMarketing_GetList_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param ObadMobileMarketing_GetList $choreo The choregraphy object for this execution.
     * @param ObadMobileMarketing_GetList_Inputs|array $inputs (optional) Inputs as ObadMobileMarketing_GetList_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
...
class ObadMobileMarketing_EditGroup extends Temboo_Choreography
{
     ...
     * Allows you to create a new group or update an existing one.
     *
     * @param Temboo_Session $session The session that owns this EditGroup choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this EditGroup choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this EditGroup choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the EditGroup choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
{
   /**
     * Inputs object with appopriate setters for the EditGroup choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this EditGroup choreography.
     *
     * @param string $value (string) Private Key for 1 unique distributor - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_EditGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ClientID input for this EditGroup choreography.
     *
     * @param int $value (integer) Private Key for 1 unique customer to connect with - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_EditGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Description input for this EditGroup choreography.
     *
    ...
    /**
     * Set the value for the Endpoint input for this EditGroup choreography.
     *
     * @param string $value (string) The base URL for the server you want to access (i.e. http://10.10.10.1). Set this to the appropriate host for the demo sandbox or production.
     * @return ObadMobileMarketing_EditGroup_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the GroupID input for this EditGroup choreography.
     *
    ...
    /**
     * Set the value for the Mode input for this EditGroup choreography.
     *
    ...
    /**
     * Set the value for the Title input for this EditGroup choreography.
     *
    ...
    /**
     * Set the value for the Type input for this EditGroup choreography.
     *
...
/**
 * Execution object for the EditGroup choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
class ObadMobileMarketing_EditGroup_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param ObadMobileMarketing_EditGroup $choreo The choregraphy object for this execution.
     * @param ObadMobileMarketing_EditGroup_Inputs|array $inputs (optional) Inputs as ObadMobileMarketing_EditGroup_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this EditGroup execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return ObadMobileMarketing_EditGroup_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the EditGroup choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
class ObadMobileMarketing_CampaignSend extends Temboo_Choreography
{
     ...
     * Generate a CSV file for sending a campaign.
     *
     * @param Temboo_Session $session The session that owns this CampaignSend choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this CampaignSend choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this CampaignSend choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the CampaignSend choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
...
{
   /**
     * Inputs object with appopriate setters for the CampaignSend choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the APIKey input for this CampaignSend choreography.
     *
     * @param string $value (string) Private Key for 1 unique distributor - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_CampaignSend_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the CampaignID input for this CampaignSend choreography.
     *
    ...
    /**
     * Set the value for the ClientID input for this CampaignSend choreography.
     *
     * @param int $value (integer) Private Key for 1 unique customer to connect with - provided by Obad Mobile Marketing
     * @return ObadMobileMarketing_CampaignSend_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Endpoint input for this CampaignSend choreography.
     *
     * @param string $value (string) The base URL for the server you want to access (i.e. http://10.10.10.1). Set this to the appropriate host for the demo sandbox or production.
     * @return ObadMobileMarketing_CampaignSend_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Type input for this CampaignSend choreography.
     *
...
/**
 * Execution object for the CampaignSend choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
class ObadMobileMarketing_CampaignSend_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param ObadMobileMarketing_CampaignSend $choreo The choregraphy object for this execution.
     * @param ObadMobileMarketing_CampaignSend_Inputs|array $inputs (optional) Inputs as ObadMobileMarketing_CampaignSend_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this CampaignSend execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return ObadMobileMarketing_CampaignSend_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the CampaignSend choreography.
 *
 * @package Temboo
 * @subpackage ObadMobileMarketing
 */
