...
class Delicious_SuggestTags extends Temboo_Choreography
{
     ...
     * Retrieves a list of suggested tags for a specifed URL.
     *
     * @param Temboo_Session $session The session that owns this SuggestTags choreography.
     ...
     *
     * Execution object provides access to results appropriate for this SuggestTags choreography.
     *
     ...
     *
     * Includes setters appropriate for this SuggestTags choreography.
     *
...
/**
 * Inputs object with appropriate setters for the SuggestTags choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
{
   /**
     * Inputs object with appopriate setters for the SuggestTags choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Password input for this SuggestTags choreography.
     *
     * @param string $value (string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_SuggestTags_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the URL input for this SuggestTags choreography.
     *
     * @param string $value (string) The URL for which to provide tagging suggestions.
     * @return Delicious_SuggestTags_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this SuggestTags choreography.
     *
     * @param string $value (string) A valid Delicious account username.
     * @return Delicious_SuggestTags_Inputs For method chaining.
     */
...
/**
 * Execution object for the SuggestTags choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
class Delicious_SuggestTags_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_SuggestTags $choreo The choregraphy object for this execution.
     * @param Delicious_SuggestTags_Inputs|array $inputs (optional) Inputs as Delicious_SuggestTags_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this SuggestTags execution.
     *
...
/**
 * Results object with appopriate getters for the SuggestTags choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
class Delicious_DeleteTag_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the Password input for this DeleteTag choreography.
     *
     * @param string $value (string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_DeleteTag_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Tag input for this DeleteTag choreography.
     *
     * @param string $value (string) The tag to delete.
     * @return Delicious_DeleteTag_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this DeleteTag choreography.
     *
     * @param string $value (string) A valid Delicious account username.
     * @return Delicious_DeleteTag_Inputs For method chaining.
     */
...
class Delicious_DeleteTag_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_DeleteTag $choreo The choregraphy object for this execution.
     * @param Delicious_DeleteTag_Inputs|array $inputs (optional) Inputs as Delicious_DeleteTag_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
...
class Delicious_GetTags_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the Password input for this GetTags choreography.
     *
     * @param string $value (string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_GetTags_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this GetTags choreography.
     *
     * @param string $value (string) A valid Delicious account username.
     * @return Delicious_GetTags_Inputs For method chaining.
     */
...
class Delicious_GetTags_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_GetTags $choreo The choregraphy object for this execution.
     * @param Delicious_GetTags_Inputs|array $inputs (optional) Inputs as Delicious_GetTags_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
...
class Delicious_GetAllBookmarks extends Temboo_Choreography
{
     ...
     * Returns all links posted to a Delicious account.
     *
     * @param Temboo_Session $session The session that owns this GetAllBookmarks choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetAllBookmarks choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetAllBookmarks choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetAllBookmarks choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetAllBookmarks choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Count input for this GetAllBookmarks choreography.
     *
    ...
    /**
     * Set the value for the FromDate input for this GetAllBookmarks choreography.
     *
    ...
    /**
     * Set the value for the Meta input for this GetAllBookmarks choreography.
     *
    ...
    /**
     * Set the value for the Password input for this GetAllBookmarks choreography.
     *
     * @param string $value (required, string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_GetAllBookmarks_Inputs For method chaining.
     */
    public function setPassword($value)
    {
    ...
    /**
     * Set the value for the Tag input for this GetAllBookmarks choreography.
     *
    ...
    /**
     * Set the value for the ToDate input for this GetAllBookmarks choreography.
     *
    ...
    /**
     * Set the value for the Username input for this GetAllBookmarks choreography.
     *
...
/**
 * Execution object for the GetAllBookmarks choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
class Delicious_GetAllBookmarks_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_GetAllBookmarks $choreo The choregraphy object for this execution.
     * @param Delicious_GetAllBookmarks_Inputs|array $inputs (optional) Inputs as Delicious_GetAllBookmarks_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetAllBookmarks execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Delicious_GetAllBookmarks_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetAllBookmarks choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
class Delicious_AddBookmark extends Temboo_Choreography
{
     ...
     * Adds a link bookmark to a Delicious account.
     *
     * @param Temboo_Session $session The session that owns this AddBookmark choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this AddBookmark choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this AddBookmark choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the AddBookmark choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
{
   /**
     * Inputs object with appopriate setters for the AddBookmark choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Description input for this AddBookmark choreography.
     *
    ...
    /**
     * Set the value for the Notes input for this AddBookmark choreography.
     *
    ...
    /**
     * Set the value for the Password input for this AddBookmark choreography.
     *
     * @param string $value (required, string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_AddBookmark_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Replace input for this AddBookmark choreography.
     *
    ...
    /**
     * Set the value for the Shared input for this AddBookmark choreography.
     *
    ...
    /**
     * Set the value for the Tags input for this AddBookmark choreography.
     *
    ...
    /**
     * Set the value for the URL input for this AddBookmark choreography.
     *
    ...
    /**
     * Set the value for the Username input for this AddBookmark choreography.
     *
     * @param string $value (required, string) A valid Delicious account username.
     * @return Delicious_AddBookmark_Inputs For method chaining.
     */
...
/**
 * Execution object for the AddBookmark choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
class Delicious_AddBookmark_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_AddBookmark $choreo The choregraphy object for this execution.
     * @param Delicious_AddBookmark_Inputs|array $inputs (optional) Inputs as Delicious_AddBookmark_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this AddBookmark execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Delicious_AddBookmark_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the AddBookmark choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
class Delicious_GetChangeSignatures extends Temboo_Choreography
{
     ...
     * Retrieves a list of all bookmarks' change detection signatures.
     *
     * @param Temboo_Session $session The session that owns this GetChangeSignatures choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetChangeSignatures choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetChangeSignatures choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetChangeSignatures choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetChangeSignatures choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Password input for this GetChangeSignatures choreography.
     *
     * @param string $value (string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_GetChangeSignatures_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this GetChangeSignatures choreography.
     *
     * @param string $value (string) A valid Delicious account username.
     * @return Delicious_GetChangeSignatures_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetChangeSignatures choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
class Delicious_GetChangeSignatures_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_GetChangeSignatures $choreo The choregraphy object for this execution.
     * @param Delicious_GetChangeSignatures_Inputs|array $inputs (optional) Inputs as Delicious_GetChangeSignatures_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetChangeSignatures execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Delicious_GetChangeSignatures_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetChangeSignatures choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
class Delicious_DeleteBookmark extends Temboo_Choreography
{
     ...
     * Deletes a bookmarked link from a Delicious account.
     *
     * @param Temboo_Session $session The session that owns this DeleteBookmark choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this DeleteBookmark choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this DeleteBookmark choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the DeleteBookmark choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
{
   /**
     * Inputs object with appopriate setters for the DeleteBookmark choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Password input for this DeleteBookmark choreography.
     *
     * @param string $value (string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_DeleteBookmark_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the URL input for this DeleteBookmark choreography.
     *
     * @param string $value (string) The URL for the posted link to delete.
     * @return Delicious_DeleteBookmark_Inputs For method chaining.
     */
    public function setURL($value)
    {
    ...
    /**
     * Set the value for the Username input for this DeleteBookmark choreography.
     *
     * @param string $value (string) A valid Delicious account username.
     * @return Delicious_DeleteBookmark_Inputs For method chaining.
     */
...
/**
 * Execution object for the DeleteBookmark choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
class Delicious_DeleteBookmark_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_DeleteBookmark $choreo The choregraphy object for this execution.
     * @param Delicious_DeleteBookmark_Inputs|array $inputs (optional) Inputs as Delicious_DeleteBookmark_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this DeleteBookmark execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Delicious_DeleteBookmark_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the DeleteBookmark choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
class Delicious_GetBookmark extends Temboo_Choreography
{
     ...
     * Retrieves one or more bookmarked links posted on a single day.
     *
     * @param Temboo_Session $session The session that owns this GetBookmark choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetBookmark choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetBookmark choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetBookmark choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetBookmark choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the ChangeSignature input for this GetBookmark choreography.
     *
    ...
    /**
     * Set the value for the Date input for this GetBookmark choreography.
     *
    ...
    /**
     * Set the value for the Meta input for this GetBookmark choreography.
     *
     * @param string $value (optional, string) Specify "1" to include a change-detection signature for each item returned. Defaults to "0", or no meta attributes retained.
     * @return Delicious_GetBookmark_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Password input for this GetBookmark choreography.
     *
     * @param string $value (required, string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_GetBookmark_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Tag input for this GetBookmark choreography.
     *
    ...
    /**
     * Set the value for the URL input for this GetBookmark choreography.
     *
    ...
    /**
     * Set the value for the Username input for this GetBookmark choreography.
     *
     * @param string $value (required, string) A valid Delicious account username.
     * @return Delicious_GetBookmark_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetBookmark choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
class Delicious_GetBookmark_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_GetBookmark $choreo The choregraphy object for this execution.
     * @param Delicious_GetBookmark_Inputs|array $inputs (optional) Inputs as Delicious_GetBookmark_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetBookmark execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Delicious_GetBookmark_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetBookmark choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
class Delicious_GetRecentBookmarks extends Temboo_Choreography
{
     ...
     * Retrieve a list of the most recently posted bookmarks.
     *
     * @param Temboo_Session $session The session that owns this GetRecentBookmarks choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetRecentBookmarks choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetRecentBookmarks choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetRecentBookmarks choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetRecentBookmarks choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Count input for this GetRecentBookmarks choreography.
     *
    ...
    /**
     * Set the value for the Password input for this GetRecentBookmarks choreography.
     *
     * @param string $value (string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_GetRecentBookmarks_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Tags input for this GetRecentBookmarks choreography.
     *
    ...
    /**
     * Set the value for the Username input for this GetRecentBookmarks choreography.
     *
     * @param string $value (string) A valid Delicious account username.
     * @return Delicious_GetRecentBookmarks_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetRecentBookmarks choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
class Delicious_GetRecentBookmarks_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_GetRecentBookmarks $choreo The choregraphy object for this execution.
     * @param Delicious_GetRecentBookmarks_Inputs|array $inputs (optional) Inputs as Delicious_GetRecentBookmarks_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetRecentBookmarks execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Delicious_GetRecentBookmarks_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetRecentBookmarks choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
class Delicious_GetBookmarkDates extends Temboo_Choreography
{
     ...
     * Retrieve a list of dates, with the number of bookmarks posted for each date.
     *
     * @param Temboo_Session $session The session that owns this GetBookmarkDates choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this GetBookmarkDates choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetBookmarkDates choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the GetBookmarkDates choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
{
   /**
     * Inputs object with appopriate setters for the GetBookmarkDates choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the Password input for this GetBookmarkDates choreography.
     *
     * @param string $value (string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_GetBookmarkDates_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Tags input for this GetBookmarkDates choreography.
     *
     * @param string $value (optional, string) Return only items tagged with the specified keyword.
     * @return Delicious_GetBookmarkDates_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this GetBookmarkDates choreography.
     *
     * @param string $value (string) A valid Delicious account username.
     * @return Delicious_GetBookmarkDates_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetBookmarkDates choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
class Delicious_GetBookmarkDates_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_GetBookmarkDates $choreo The choregraphy object for this execution.
     * @param Delicious_GetBookmarkDates_Inputs|array $inputs (optional) Inputs as Delicious_GetBookmarkDates_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this GetBookmarkDates execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Delicious_GetBookmarkDates_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the GetBookmarkDates choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
class Delicious_RenameTag extends Temboo_Choreography
{
     ...
     * Renames a specified tag.
     *
     * @param Temboo_Session $session The session that owns this RenameTag choreography.
     ...
     * Executes this choreography.
     *
     * Execution object provides access to results appropriate for this RenameTag choreography.
     *
     ...
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this RenameTag choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
...
/**
 * Inputs object with appropriate setters for the RenameTag choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
...
{
   /**
     * Inputs object with appopriate setters for the RenameTag choreography.
     *
     * @param array $inputs (optional) Associative array of input names and values.
    ...
    /**
     * Set the value for the NewTag input for this RenameTag choreography.
     *
     * @param string $value (string) The new tag name.
     * @return Delicious_RenameTag_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the OldTag input for this RenameTag choreography.
     *
     * @param string $value (string) The existing tag to rename.
     * @return Delicious_RenameTag_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Password input for this RenameTag choreography.
     *
     * @param string $value (string) The password that corresponds to the specified Delicious account username.
     * @return Delicious_RenameTag_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Username input for this RenameTag choreography.
     *
     * @param string $value (string) A valid Delicious account username.
     * @return Delicious_RenameTag_Inputs For method chaining.
     */
...
/**
 * Execution object for the RenameTag choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
class Delicious_RenameTag_Execution extends Temboo_Choreography_Execution
{
     ...
     * @param Delicious_RenameTag $choreo The choregraphy object for this execution.
     * @param Delicious_RenameTag_Inputs|array $inputs (optional) Inputs as Delicious_RenameTag_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
    ...
    /**
     * Wraps results in appopriate results class for this RenameTag execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Delicious_RenameTag_Results New results object.
     */
...
/**
 * Results object with appopriate getters for the RenameTag choreography.
 *
 * @package Temboo
 * @subpackage Delicious
 */
